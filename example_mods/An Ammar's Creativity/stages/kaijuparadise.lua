...
function onCreate()
	...
	makeGraphic("wallbackdoor", 700, 420, '000000')
	...
	makeAnimatedLuaSprite("thegirl", folder..'The Girl', -800, 150)
	addAnimationByPrefix("thegirl", "bop", "thegirl_bop", 24, false)
	scaleObject('thegirl', 2.5, 2.5)
	...
	makeAnimatedLuaSprite("fox", folder..'KreatorFox', -300, 1000)
	...
	makeAnimatedLuaSprite("hazzy", folder..'front/Hazzy', 1300, 630)
