...
function onCreatePost()
    ...
    if songName:lower() == 'programming-an-ammar' then
        setProperty("bottomGlow.alpha", 0.6)
        setProperty("middleGlow.alpha", 0.6)
        setProperty("middleGlowOverlay.alpha", 0.6)
        setProperty("bfOverlay.alpha", 0.5)
    end
end
