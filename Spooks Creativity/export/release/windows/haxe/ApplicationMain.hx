...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Spooks Creativity", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Spooks Creativity", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5";
		app.meta["company"] = "Spook";
		app.meta["file"] = "Spooks Creativity";
		app.meta["name"] = "Friday Night Funkin': Spook's Creativity V1";
		app.meta["packageName"] = "com.spook.spookscreativity";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Spook's Creativity V1",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Spook's Creativity V1";
		#else
