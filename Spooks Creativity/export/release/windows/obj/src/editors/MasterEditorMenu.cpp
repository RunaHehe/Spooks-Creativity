...
static const ::String _hx_array_data_7d8f0896_1[] = {
	HX_("Character Editor",84,45,58,b1),HX_("Chart Editor",ef,b4,29,e9),
};
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_35_create,"editors.MasterEditorMenu","create",0xee5b93d4,"editors.MasterEditorMenu.create","editors/MasterEditorMenu.hx",35,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_85_update,"editors.MasterEditorMenu","update",0xf951b2e1,"editors.MasterEditorMenu.update","editors/MasterEditorMenu.hx",85,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_143_changeSelection,"editors.MasterEditorMenu","changeSelection",0x385910e4,"editors.MasterEditorMenu.changeSelection","editors/MasterEditorMenu.hx",143,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_156_changeDirectory,"editors.MasterEditorMenu","changeDirectory",0xba830b05,"editors.MasterEditorMenu.changeDirectory","editors/MasterEditorMenu.hx",156,0x3933e087)
namespace editors{
...
HXLINE(  23)		this->options = ::Array_obj< ::String >::fromData( _hx_array_data_7d8f0896_1,2);
...
void MasterEditorMenu_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_aa1a162bced268b8_35_create)
HXLINE(  36)		::flixel::FlxG_obj::camera->bgColor = -16777216;
HXLINE(  39)		::DiscordClient_obj::changePresence(HX_("Editors Main Menu",4c,98,82,a7),null(),null(),null(),null());
HXLINE(  42)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  42)		::String library = null();
HXDLIN(  42)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuDesat",26,91,04,72),library);
HXDLIN(  42)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  43)		{
...
HXLINE(  52)				 ::Alphabet leText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(90) ),( (Float)(320) ),this->options->__get(i),true);
HXLINE(  53)				leText->isMenuItem = true;
HXLINE(  54)				leText->targetY = i;
HXLINE(  55)				this->grpTexts->add(leText).StaticCast<  ::Alphabet >();
...
HXDLIN(  65)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
...
HXLINE(  69)		{
HXLINE(  69)			int _g2 = 0;
HXDLIN(  69)			::Array< ::String > _g3 = ::Paths_obj::getModDirectories();
...
HXLINE(  74)		int found = this->directories->indexOf(::Paths_obj::currentModDirectory,null());
...
void MasterEditorMenu_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_aa1a162bced268b8_85_update)
HXLINE(  86)		if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
HXLINE(  88)			this->changeSelection(-1);
            		}
HXLINE(  90)		if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
HXLINE(  92)			this->changeSelection(1);
            		}
HXLINE(  95)		if (::PlayerSettings_obj::player1->controls->_ui_leftP->check()) {
HXLINE(  97)			this->changeDirectory(-1);
            		}
HXLINE(  99)		if (::PlayerSettings_obj::player1->controls->_ui_rightP->check()) {
HXLINE( 101)			this->changeDirectory(1);
            		}
HXLINE( 105)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 107)			::MusicBeatState_obj::switchState( ::MainMenuStateAmmar_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 110)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 112)			::String _hx_switch_0 = this->options->__get(this->curSelected);
            			if (  (_hx_switch_0==HX_("Character Editor",84,45,58,b1)) ){
HXLINE( 114)				::MusicBeatState_obj::switchState(::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::CharacterEditorState_obj::__alloc( HX_CTX ,::Character_obj::DEFAULT_CHARACTER,false)) ),false));
HXDLIN( 114)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Chart Editor",ef,b4,29,e9)) ){
HXLINE( 116)				::MusicBeatState_obj::switchState(::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::ChartingState_obj::__alloc( HX_CTX ,null(),null())) ),false));
HXDLIN( 116)				goto _hx_goto_5;
            			}
            			_hx_goto_5:;
HXLINE( 118)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
HXLINE( 120)			::FreeplayState_obj::destroyFreeplayVocals();
            		}
HXLINE( 124)		int bullShit = 0;
HXLINE( 125)		{
HXLINE( 125)			int _g = 0;
HXDLIN( 125)			::Array< ::Dynamic> _g1 = this->grpTexts->members;
HXDLIN( 125)			while((_g < _g1->length)){
HXLINE( 125)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 125)				_g = (_g + 1);
HXLINE( 127)				item->targetY = (bullShit - this->curSelected);
...
void MasterEditorMenu_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_143_changeSelection)
HXLINE( 144)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 144)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 146)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 146)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 148)		if ((this->curSelected < 0)) {
HXLINE( 149)			this->curSelected = (this->options->length - 1);
            		}
HXLINE( 150)		if ((this->curSelected >= this->options->length)) {
...
void MasterEditorMenu_obj::changeDirectory(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_156_changeDirectory)
HXLINE( 157)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 157)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 159)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 159)		_hx_tmp1->curDirectory = (_hx_tmp1->curDirectory + change);
HXLINE( 161)		if ((this->curDirectory < 0)) {
HXLINE( 162)			this->curDirectory = (this->directories->length - 1);
            		}
HXLINE( 163)		if ((this->curDirectory >= this->directories->length)) {
HXLINE( 164)			this->curDirectory = 0;
            		}
HXLINE( 166)		::WeekData_obj::setDirectoryFromWeek(null());
HXLINE( 167)		bool _hx_tmp2;
HXDLIN( 167)		if (::hx::IsNotNull( this->directories->__get(this->curDirectory) )) {
HXLINE( 167)			_hx_tmp2 = (this->directories->__get(this->curDirectory).length < 1);
            		}
            		else {
HXLINE( 167)			_hx_tmp2 = true;
            		}
HXDLIN( 167)		if (_hx_tmp2) {
HXLINE( 168)			this->directoryTxt->set_text(HX_("< No Mod Directory Loaded >",6f,05,c4,e1));
            		}
            		else {
HXLINE( 171)			::Paths_obj::currentModDirectory = this->directories->__get(this->curDirectory);
HXLINE( 172)			this->directoryTxt->set_text(((HX_("< Loaded Mod Directory: ",1e,b9,7b,3e) + ::Paths_obj::currentModDirectory) + HX_(" >",1e,1c,00,00)));
            		}
HXLINE( 174)		 ::flixel::text::FlxText _hx_tmp3 = this->directoryTxt;
HXDLIN( 174)		_hx_tmp3->set_text(this->directoryTxt->text.toUpperCase());
            	}
