...
HXLINE(  79)		{
HXLINE(  79)			int _g = 0;
HXDLIN(  79)			while((_g < 4)){
HXLINE(  79)				_g = (_g + 1);
HXDLIN(  79)				int i = (_g - 1);
HXLINE(  80)				this->set((HX_("defaultPlayerStrumX",91,a3,83,89) + i),0);
HXLINE(  81)				this->set((HX_("defaultPlayerStrumY",92,a3,83,89) + i),0);
HXLINE(  82)				this->set((HX_("defaultOpponentStrumX",0d,e1,d7,f1) + i),0);
HXLINE(  83)				this->set((HX_("defaultOpponentStrumY",0e,e1,d7,f1) + i),0);
            			}
            		}
