...
HXLINE( 345)		::Array< Float > daOffset = ( (::Array< Float >)(this->animOffsets->get(AnimName)) );
HXLINE( 346)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 348)			 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN( 348)			Float y = (daOffset->__get(1) * this->scale->y);
HXDLIN( 348)			this1->set_x((daOffset->__get(0) * this->scale->x));
HXDLIN( 348)			this1->set_y(y);
            		}
            		else {
...
HXDLIN( 413)		::Array< Float > v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
