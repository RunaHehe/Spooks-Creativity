...
HX_DEFINE_STACK_FRAME(_hx_pos_5355c1500aa58f96_395_new,"GameplayOption","new",0x2ac2d98d,"GameplayOption.new","GameplayChangersSubstate.hx",395,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_472_change,"GameplayOption","change",0x8d0dc263,"GameplayOption.change","GameplayChangersSubstate.hx",472,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_479_getValue,"GameplayOption","getValue",0x690f22ae,"GameplayOption.getValue","GameplayChangersSubstate.hx",479,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_483_setValue,"GameplayOption","setValue",0x176c7c22,"GameplayOption.setValue","GameplayChangersSubstate.hx",483,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_488_setChild,"GameplayOption","setChild",0x2b6da64d,"GameplayOption.setChild","GameplayChangersSubstate.hx",488,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_492_get_text,"GameplayOption","get_text",0xa4341be9,"GameplayOption.get_text","GameplayChangersSubstate.hx",492,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_499_set_text,"GameplayOption","set_text",0x5291755d,"GameplayOption.set_text","GameplayChangersSubstate.hx",499,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_507_get_type,"GameplayOption","get_type",0xa44341f6,"GameplayOption.get_type","GameplayChangersSubstate.hx",507,0xb1374db6)
...
void GameplayOption_obj::__construct(::String name,::String variable,::String __o_type, ::Dynamic __o_defaultValue,::Array< ::String > options){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_395_new)
HXLINE( 419)		this->name = HX_("Unknown",6a,4b,cc,ae);
HXLINE( 418)		this->displayFormat = HX_("%v",b1,20,00,00);
HXLINE( 416)		this->decimals = 1;
HXLINE( 415)		this->maxValue = null();
HXLINE( 414)		this->minValue = null();
HXLINE( 413)		this->changeValue = 1;
HXLINE( 412)		this->options = null();
HXLINE( 411)		this->curOption = 0;
HXLINE( 409)		this->defaultValue = null();
HXLINE( 408)		this->variable = null();
HXLINE( 406)		this->scrollSpeed = ((Float)50);
HXLINE( 405)		this->showBoyfriend = false;
HXLINE( 401)		this->type = HX_("bool",2a,84,1b,41);
HXLINE( 399)		this->onChange = null();
HXLINE( 423)		this->name = name;
HXLINE( 424)		this->variable = variable;
HXLINE( 425)		this->type = type;
HXLINE( 426)		this->defaultValue = defaultValue;
HXLINE( 427)		this->options = options;
HXLINE( 429)		if (::hx::IsEq( defaultValue,HX_("null variable value",06,3c,3f,e9) )) {
HXLINE( 431)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("bool",2a,84,1b,41)) ){
HXLINE( 434)				defaultValue = false;
HXDLIN( 434)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("float",9c,c5,96,02)) ||  (_hx_switch_0==HX_("int",ef,0c,50,00)) ){
HXLINE( 436)				defaultValue = 0;
HXDLIN( 436)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("percent",c5,aa,da,78)) ){
HXLINE( 438)				defaultValue = 1;
HXDLIN( 438)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("string",d1,28,30,11)) ){
HXLINE( 440)				defaultValue = HX_("",00,00,00,00);
HXLINE( 441)				if ((options->length > 0)) {
HXLINE( 442)					defaultValue = options->__get(0);
            				}
HXLINE( 439)				goto _hx_goto_0;
            			}
            			_hx_goto_0:;
            		}
HXLINE( 447)		if (::hx::IsNull( this->getValue() )) {
HXLINE( 448)			this->setValue(defaultValue);
            		}
HXLINE( 451)		::String _hx_switch_1 = type;
            		if (  (_hx_switch_1==HX_("percent",c5,aa,da,78)) ){
HXLINE( 460)			this->displayFormat = HX_("%v%",54,7a,1c,00);
HXLINE( 461)			this->changeValue = ((Float)0.01);
HXLINE( 462)			this->minValue = 0;
HXLINE( 463)			this->maxValue = 1;
HXLINE( 464)			this->scrollSpeed = ((Float)0.5);
HXLINE( 465)			this->decimals = 2;
HXLINE( 459)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_1==HX_("string",d1,28,30,11)) ){
HXLINE( 454)			int num = options->indexOf(this->getValue(),null());
HXLINE( 455)			if ((num > -1)) {
HXLINE( 456)				this->curOption = num;
            			}
HXLINE( 453)			goto _hx_goto_1;
            		}
            		_hx_goto_1:;
            	}
...
void GameplayOption_obj::change(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_472_change)
HXDLIN( 472)		if (::hx::IsNotNull( this->onChange )) {
HXLINE( 473)			this->onChange();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GameplayOption_obj,change,(void))
 ...
 ::Dynamic GameplayOption_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_479_getValue)
HXDLIN( 479)		return ::ClientPrefs_obj::gameplaySettings->get(this->variable);
            	}
...
void GameplayOption_obj::setValue( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_483_setValue)
HXDLIN( 483)		::ClientPrefs_obj::gameplaySettings->set(this->variable,value);
            	}
...
void GameplayOption_obj::setChild( ::Alphabet child){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_488_setChild)
HXDLIN( 488)		this->child = child;
            	}
...
::String GameplayOption_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_492_get_text)
HXLINE( 493)		if (::hx::IsNotNull( this->child )) {
HXLINE( 494)			return this->child->text;
            		}
...
::String GameplayOption_obj::set_text(::String __o_newValue){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_499_set_text)
HXLINE( 500)		if (::hx::IsNotNull( this->child )) {
HXLINE( 501)			this->child->set_text(newValue);
            		}
...
::String GameplayOption_obj::get_type(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_507_get_type)
HXLINE( 508)		::String newValue = HX_("bool",2a,84,1b,41);
HXLINE( 509)		::String _hx_switch_0 = ::StringTools_obj::trim(this->type.toLowerCase());
            		if (  (_hx_switch_0==HX_("fl",46,59,00,00)) ){
HXLINE( 514)			newValue = HX_("float",9c,c5,96,02);
HXDLIN( 514)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("integer",be,bd,1b,17)) ){
HXLINE( 512)			newValue = HX_("int",ef,0c,50,00);
HXDLIN( 512)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("str",b1,a8,57,00)) ){
HXLINE( 513)			newValue = HX_("string",d1,28,30,11);
...
HXLINE( 511)			newValue = this->type;
HXDLIN( 511)			goto _hx_goto_9;
            		}
            		_hx_goto_9:;
HXLINE( 516)		this->type = newValue;
HXLINE( 517)		return this->type;
            	}
