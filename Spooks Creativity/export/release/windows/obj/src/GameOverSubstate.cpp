...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_124_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",124,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_147_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",147,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_156_coolStartDeath,"GameOverSubstate","coolStartDeath",0x265fa8f2,"GameOverSubstate.coolStartDeath","GameOverSubstate.hx",156,0x01fbc1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_173_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",173,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_171_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",171,0x01fbc1e7)
...
HXLINE( 152)		this->isEnding = false;
...
HXLINE(  98)			::MusicBeatState_obj::switchState( ::MainMenuStateAmmar_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 100)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 100)			::String library = null();
HXDLIN( 100)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 100)			_hx_tmp->playMusic(file,null(),null(),null());
HXLINE( 101)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,false),null(),null());
            		}
HXLINE( 104)		bool _hx_tmp1;
HXDLIN( 104)		if (::hx::IsNotNull( this->boyfriend->animation->_curAnim )) {
HXLINE( 104)			_hx_tmp1 = (this->boyfriend->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14));
            		}
            		else {
...
HXDLIN( 106)			if ((this->boyfriend->animation->_curAnim->curFrame >= 12)) {
HXLINE( 106)				_hx_tmp2 = !(this->isFollowingAlready);
            			}
            			else {
HXLINE( 106)				_hx_tmp2 = false;
            			}
HXDLIN( 106)			if (_hx_tmp2) {
HXLINE( 108)				::flixel::FlxG_obj::camera->follow(this->camFollowPos,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),1);
HXLINE( 109)				this->updateCamera = true;
HXLINE( 110)				this->isFollowingAlready = true;
            			}
HXLINE( 113)			bool _hx_tmp3;
HXDLIN( 113)			if (this->boyfriend->animation->_curAnim->finished) {
HXLINE( 113)				_hx_tmp3 = !(this->playingDeathSound);
            			}
            			else {
HXLINE( 113)				_hx_tmp3 = false;
            			}
HXDLIN( 113)			if (_hx_tmp3) {
HXLINE( 115)				if (::hx::IsEq( ::PlayState_obj::SONG->__Field(HX_("stage",be,6a,0b,84),::hx::paccDynamic),HX_("tank",ea,ba,f6,4c) )) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::GameOverSubstate,_gthis) HXARGC(0)
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_124_update)
HXLINE( 124)						if (!(_gthis->isEnding)) {
HXLINE( 126)							 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXDLIN( 126)							_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(1) ),( (Float)(4) ),((Float)0.2), ::Dynamic(::hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            						}
            					}
            					HX_END_LOCAL_FUNC0((void))

HXLINE( 117)					this->playingDeathSound = true;
HXLINE( 118)					this->coolStartDeath(((Float)0.2));
HXLINE( 120)					::Array< int > exclude = ::Array_obj< int >::__new(0);
HXLINE( 123)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp4 = ::flixel::FlxG_obj::sound;
HXDLIN( 123)					_hx_tmp4->play(::Paths_obj::sound((HX_("jeffGameover/jeffGameover-",3e,03,48,86) + ::flixel::FlxG_obj::random->_hx_int(1,25,exclude)),null()),1,false,null(),true, ::Dynamic(new _hx_Closure_0(_gthis)));
            				}
            				else {
HXLINE( 132)					this->coolStartDeath(null());
            				}
HXLINE( 134)				this->boyfriend->startedDeath = true;
            			}
            		}
...
HXLINE( 142)		::PlayState_obj::instance->callOnLuas(HX_("onUpdatePost",08,11,55,db),::cpp::VirtualArray_obj::__new(1)->init(0,elapsed),null(),null());
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_147_beatHit)
HXDLIN( 147)		this->super::beatHit();
            	}
...
void GameOverSubstate_obj::coolStartDeath( ::Dynamic __o_volume){
            	...
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_156_coolStartDeath)
HXDLIN( 156)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 156)		::String library = null();
HXDLIN( 156)		 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::GameOverSubstate_obj::loopSoundName,library);
HXDLIN( 156)		_hx_tmp->playMusic(file,volume,null(),null());
            	}
...
HXDLIN( 161)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_173_endBullshit)
HXLINE( 173)					::MusicBeatState_obj::resetState();
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_171_endBullshit)
HXLINE( 171)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 163)			if (!(::ClientPrefs_obj::developer)) {
HXLINE( 164)				::antidebug::DebugSave_obj::updateFolder(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ));
            			}
HXLINE( 165)			this->isEnding = true;
HXLINE( 166)			this->boyfriend->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 167)			{
HXLINE( 167)				 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 167)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE( 168)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 168)			::String library = null();
HXDLIN( 168)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::GameOverSubstate_obj::endSoundName,library);
HXDLIN( 168)			_hx_tmp->play(file,null(),null(),null(),null(),null());
HXLINE( 169)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
HXLINE( 176)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,true),null(),null());
            		}
            	}
