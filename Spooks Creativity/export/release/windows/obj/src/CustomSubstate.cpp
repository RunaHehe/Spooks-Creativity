...
HX_DEFINE_STACK_FRAME(_hx_pos_8557063211c1ebb8_3499_new,"CustomSubstate","new",0xac1d5774,"CustomSubstate.new","FunkinLua.hx",3499,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3490_create,"CustomSubstate","create",0xdcec8468,"CustomSubstate.create","FunkinLua.hx",3490,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3506_update,"CustomSubstate","update",0xe7e2a375,"CustomSubstate.update","FunkinLua.hx",3506,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3513_destroy,"CustomSubstate","destroy",0x8522ce0e,"CustomSubstate.destroy","FunkinLua.hx",3513,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3486_boot,"CustomSubstate","boot",0xe5a82e9e,"CustomSubstate.boot","FunkinLua.hx",3486,0x00117937)

void CustomSubstate_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3499_new)
HXLINE(3500)		::CustomSubstate_obj::name = name;
HXLINE(3501)		super::__construct();
HXLINE(3502)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
            	}
...
void CustomSubstate_obj::create(){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3490_create)
HXLINE(3491)		::CustomSubstate_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(3493)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreate",bd,00,5a,98),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
HXLINE(3494)		this->super::create();
HXLINE(3495)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreatePost",bd,53,4b,d5),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
            	}


void CustomSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3506_update)
HXLINE(3507)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdate",ca,1f,50,a3),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null());
HXLINE(3508)		this->super::update(elapsed);
HXLINE(3509)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdatePost",4a,7d,72,7b),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null());
            	}


void CustomSubstate_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3513_destroy)
HXLINE(3514)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateDestroy",19,1c,82,c9),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
HXLINE(3515)		this->super::destroy();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3486_boot)
HXDLIN(3486)		name = HX_("unnamed",c0,86,15,93);
            	}
}
