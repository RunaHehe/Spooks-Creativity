...
HXLINE( 746)					_hx_tmp1 = (name.length > 0);
            				}
            				else {
...
HXLINE( 750)				bool _hx_tmp2;
HXDLIN( 750)				if (::hx::IsNotNull( description )) {
HXLINE( 750)					_hx_tmp2 = (description.length > 0);
            				}
            				else {
...
HXLINE( 754)				if ((name == HX_("Name",6b,9e,d8,33))) {
HXLINE( 756)					this->name = folder;
            				}
HXLINE( 758)				if ((description == HX_("Description",dc,a0,4f,43))) {
HXLINE( 760)					this->description = HX_("No description provided.",88,46,cb,66);
            				}
HXLINE( 762)				bool _hx_tmp3;
HXDLIN( 762)				if (::hx::IsNotNull( colors )) {
HXLINE( 762)					_hx_tmp3 = (colors->length > 2);
            				}
            				else {
HXLINE( 762)					_hx_tmp3 = false;
            				}
HXDLIN( 762)				if (_hx_tmp3) {
HXLINE( 764)					int Red = colors->__get(0);
HXDLIN( 764)					int Green = colors->__get(1);
HXDLIN( 764)					int Blue = colors->__get(2);
HXDLIN( 764)					int Alpha = 255;
HXDLIN( 764)					int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 764)					{
HXLINE( 764)						color = (color & -16711681);
HXDLIN( 764)						int color1;
HXDLIN( 764)						if ((Red > 255)) {
HXLINE( 764)							color1 = 255;
            						}
            						else {
HXLINE( 764)							if ((Red < 0)) {
HXLINE( 764)								color1 = 0;
...
HXLINE( 764)								color1 = Red;
            							}
            						}
HXDLIN( 764)						color = (color | (color1 << 16));
            					}
HXDLIN( 764)					{
HXLINE( 764)						color = (color & -65281);
HXDLIN( 764)						int color2;
HXDLIN( 764)						if ((Green > 255)) {
HXLINE( 764)							color2 = 255;
            						}
            						else {
HXLINE( 764)							if ((Green < 0)) {
HXLINE( 764)								color2 = 0;
            							}
            							else {
HXLINE( 764)								color2 = Green;
            							}
            						}
HXDLIN( 764)						color = (color | (color2 << 8));
            					}
HXDLIN( 764)					{
HXLINE( 764)						color = (color & -256);
HXDLIN( 764)						int color3;
HXDLIN( 764)						if ((Blue > 255)) {
HXLINE( 764)							color3 = 255;
            						}
            						else {
HXLINE( 764)							if ((Blue < 0)) {
HXLINE( 764)								color3 = 0;
            							}
            							else {
HXLINE( 764)								color3 = Blue;
            							}
            						}
HXDLIN( 764)						color = (color | color3);
            					}
HXDLIN( 764)					{
HXLINE( 764)						color = (color & 16777215);
HXDLIN( 764)						int color4;
HXDLIN( 764)						if ((Alpha > 255)) {
HXLINE( 764)							color4 = 255;
            						}
            						else {
HXLINE( 764)							if ((Alpha < 0)) {
HXLINE( 764)								color4 = 0;
            							}
            							else {
HXLINE( 764)								color4 = Alpha;
            							}
            						}
HXDLIN( 764)						color = (color | (color4 << 24));
            					}
HXDLIN( 764)					this->color = color;
            				}
HXLINE( 767)				this->restart = restart;
            			}
            		}
            	}
