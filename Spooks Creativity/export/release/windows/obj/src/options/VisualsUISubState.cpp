...
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_98_onChangePauseMusic,"options.VisualsUISubState","onChangePauseMusic",0xdfdbfe24,"options.VisualsUISubState.onChangePauseMusic","options/VisualsUISubState.hx",98,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_108_destroy,"options.VisualsUISubState","destroy",0x298befb4,"options.VisualsUISubState.destroy","options/VisualsUISubState.hx",108,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_116_onChangeFPSCounter,"options.VisualsUISubState","onChangeFPSCounter",0xf92afa68,"options.VisualsUISubState.onChangeFPSCounter","options/VisualsUISubState.hx",116,0x3f30f917)
namespace options{

void VisualsUISubState_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4e14480e50e84747_30_new)
HXLINE(  96)		this->changedMusic = false;
...
HXLINE(  51)		 ::options::Option option2 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Camera Zooms",45,a6,9b,43),HX_("If unchecked, the camera won't zoom in on a beat hit.",fd,78,13,6b),HX_("camZooms",71,f3,cd,90),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  56)		this->addOption(option2);
HXLINE(  59)		 ::options::Option option3 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("FPS Counter",85,ef,54,c9),HX_("If unchecked, hides FPS Counter.",17,fc,a1,74),HX_("showFPS",ec,0a,9a,7b),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  64)		this->addOption(option3);
HXLINE(  65)		option3->onChange = this->onChangeFPSCounter_dyn();
HXLINE(  68)		 ::options::Option option4 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Pause Screen Song:",9b,6e,16,2a),HX_("What song do you prefer for the Pause Screen?",9a,c8,b3,59),HX_("pauseMusic",cf,6d,d3,e5),HX_("string",d1,28,30,11),HX_("Tea Time",9d,d4,cb,99),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_1,3));
HXLINE(  74)		this->addOption(option4);
HXLINE(  75)		option4->onChange = this->onChangePauseMusic_dyn();
HXLINE(  86)		 ::options::Option option5 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Combo Stacking",ec,30,59,b7),HX_("If unchecked, Ratings and Combo won't stack, saving on System Memory and making them easier to read",d6,be,78,3a),HX_("comboStacking",08,45,bb,e0),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  91)		this->addOption(option5);
...
void VisualsUISubState_obj::onChangePauseMusic(){
            	HX_GC_STACKFRAME(&_hx_pos_4e14480e50e84747_98_onChangePauseMusic)
HXLINE(  99)		if ((::ClientPrefs_obj::pauseMusic == HX_("None",d8,3e,e3,33))) {
HXLINE( 100)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
            		}
            		else {
HXLINE( 102)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 102)			::String path = ::ClientPrefs_obj::pauseMusic;
HXDLIN( 102)			 ::EReg invalidChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXDLIN( 102)			 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXDLIN( 102)			::String path1 = invalidChars->split(::StringTools_obj::replace(path,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
HXDLIN( 102)			::String library = null();
HXDLIN( 102)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),hideChars->split(path1)->join(HX_("",00,00,00,00)).toLowerCase(),library);
HXDLIN( 102)			_hx_tmp->playMusic(file,null(),null(),null());
            		}
HXLINE( 104)		this->changedMusic = true;
            	}
...
void VisualsUISubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_108_destroy)
HXLINE( 109)		if (this->changedMusic) {
HXLINE( 109)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 109)			::String library = null();
HXDLIN( 109)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 109)			_hx_tmp->playMusic(file,null(),null(),null());
            		}
HXLINE( 110)		this->super::destroy();
            	}


void VisualsUISubState_obj::onChangeFPSCounter(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_116_onChangeFPSCounter)
HXDLIN( 116)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE( 117)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
