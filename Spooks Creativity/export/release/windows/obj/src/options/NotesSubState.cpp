...
static const ::String _hx_array_data_0afa74a2_3[] = {
...
HXLINE(  65)				{
HXLINE(  65)					int _g2 = 0;
HXDLIN(  65)					while((_g2 < 3)){
HXLINE(  65)						_g2 = (_g2 + 1);
HXDLIN(  65)						int j = (_g2 - 1);
HXLINE(  66)						int optionText = ((this->posX + (225 * j)) + 250);
HXDLIN(  66)						 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(optionText) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(j)),true);
...
HXLINE(  72)				::Array< ::String > animations = ::Array_obj< ::String >::fromData( _hx_array_data_0afa74a2_3,4);
