...
static const ::String _hx_array_data_23c4ab78_8[] = {
	HX_("Mint",c2,7a,35,33),HX_("Lumi",45,5e,95,32),HX_("Blue Evil Spook",e8,2f,6d,67),HX_("Floppa",b8,f5,f5,75),HX_("Dr Ludwig",8c,d7,ba,b6),HX_("Professor Mod",51,28,3b,45),
};
static const ::String _hx_array_data_23c4ab78_9[] = {
	HX_("Spook",ae,a6,9e,14),
};
static const ::String _hx_array_data_23c4ab78_10[] = {
	HX_("An Ammar",bf,8d,de,e4),HX_("Annoyer",58,7f,03,2a),HX_("Spook",ae,a6,9e,14),HX_("Mint",c2,7a,35,33),HX_("Tutu",62,19,df,37),HX_("Blue Evil Spook",e8,2f,6d,67),HX_("Dave",0c,84,3c,2d),HX_("Lumi",45,5e,95,32),HX_("Bellita",d3,d2,8d,91),HX_("Andro",34,72,0d,b6),HX_("Sharky",14,d8,bf,51),HX_("Silly",03,df,fb,0f),HX_("Smartty",ae,d7,ec,35),HX_("Brickman",d9,7d,c1,86),HX_("Floppa",b8,f5,f5,75),HX_("ImBakeyy",5d,12,79,88),HX_("Dr Ludwig",8c,d7,ba,b6),HX_("Thatoneguy",ac,02,1b,49),HX_("Vision",08,88,17,24),HX_("Jamki",d4,b2,17,dc),HX_("Professor Mod",51,28,3b,45),HX_("Mask",0c,6d,2f,33),
};
...
HXLINE(  19)		this->modList = ::Array_obj< ::String >::fromData( _hx_array_data_23c4ab78_8,6);
...
HXLINE(  14)		this->daMembers = ::Array_obj< ::String >::fromData( _hx_array_data_23c4ab78_10,22);
