...
HXLINE( 142)		this->_hx___pendingHeight = 228;
HXLINE( 141)		this->_hx___pendingWidth = 400;
HXLINE( 140)		this->_hx___opened = false;
...
HXLINE( 178)			this->_hx___opened = true;
HXLINE( 179)			this->_hx___pendingWidth = this->_hx___window->_hx___width;
HXLINE( 180)			this->_hx___pendingHeight = this->_hx___window->_hx___height;
...
HXLINE( 187)			this->_hx___window = Dynamic( app->createWindow( ::Dynamic(::hx::Anon_obj::Create(12)
            				...
            				->setFixed(11,HX_("hidden",6a,ff,95,4c),false)))).StaticCast<  ::openfl::display::Window >();
...
HXLINE( 209)		this->_hx___previousWidth = this->_hx___pendingWidth;
HXLINE( 210)		this->_hx___previousHeight = this->_hx___pendingHeight;
...
HXLINE( 370)		if (!(this->_hx___opened)) {
HXLINE( 372)			return ( (Float)(this->_hx___pendingWidth) );
            		}
...
HXLINE( 385)		if (!(this->_hx___opened)) {
HXLINE( 387)			return ( (Float)((this->_hx___pendingWidth = ::Std_obj::_hx_int(value))) );
            		}
...
HXLINE( 431)		if (!(this->_hx___opened)) {
HXLINE( 433)			return ( (Float)(this->_hx___pendingHeight) );
            		}
...
HXLINE( 446)		if (!(this->_hx___opened)) {
HXLINE( 448)			return ( (Float)((this->_hx___pendingHeight = ::Std_obj::_hx_int(value))) );
            		}
...
HXLINE( 574)		return this->_hx___opened;
            	}
...
HXLINE( 587)		if (!(this->_hx___opened)) {
HXLINE( 589)			this->_hx___opened = true;
HXLINE( 590)			this->_hx___previousWidth = this->_hx___pendingWidth;
HXLINE( 591)			this->_hx___previousHeight = this->_hx___pendingHeight;
HXLINE( 592)			this->_hx___window->set_width(this->_hx___pendingWidth);
HXLINE( 593)			this->_hx___window->set_height(this->_hx___pendingHeight);
            		}
HXLINE( 595)		if (!(value)) {
HXLINE( 597)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Setting NativeWindow visible to false is not supported at this time",8c,a2,b0,1d)));
            		}
HXLINE( 599)		return this->_hx___opened;
            	}
...
void NativeWindow_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_hx___opened,"__opened");
	HX_MARK_MEMBER_NAME(_hx___pendingWidth,"__pendingWidth");
	HX_MARK_MEMBER_NAME(_hx___pendingHeight,"__pendingHeight");
...
void NativeWindow_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_hx___opened,"__opened");
	HX_VISIT_MEMBER_NAME(_hx___pendingWidth,"__pendingWidth");
	HX_VISIT_MEMBER_NAME(_hx___pendingHeight,"__pendingHeight");
...
::hx::Val NativeWindow_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__opened") ) { return ::hx::Val( _hx___opened ); }
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__pendingWidth") ) { return ::hx::Val( _hx___pendingWidth ); }
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__pendingHeight") ) { return ::hx::Val( _hx___pendingHeight ); }
...
::hx::Val NativeWindow_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__opened") ) { _hx___opened=inValue.Cast< bool >(); return inValue; }
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__pendingWidth") ) { _hx___pendingWidth=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__ownedWindows") ) { _hx___ownedWindows=inValue.Cast<  ::openfl::_Vector::ObjectVector >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__pendingHeight") ) { _hx___pendingHeight=inValue.Cast< int >(); return inValue; }
...
void NativeWindow_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("__opened",c9,cd,c3,c9));
	outFields->push(HX_("__pendingWidth",4f,75,c9,a2));
	outFields->push(HX_("__pendingHeight",7e,a8,cc,83));
...
static ::hx::StorageInfo NativeWindow_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(NativeWindow_obj,_hx___opened),HX_("__opened",c9,cd,c3,c9)},
	{::hx::fsInt,(int)offsetof(NativeWindow_obj,_hx___pendingWidth),HX_("__pendingWidth",4f,75,c9,a2)},
	{::hx::fsInt,(int)offsetof(NativeWindow_obj,_hx___pendingHeight),HX_("__pendingHeight",7e,a8,cc,83)},
...
static ::String NativeWindow_obj_sMemberFields[] = {
	...
	HX_("__opened",c9,cd,c3,c9),
	HX_("__pendingWidth",4f,75,c9,a2),
	HX_("__pendingHeight",7e,a8,cc,83),
