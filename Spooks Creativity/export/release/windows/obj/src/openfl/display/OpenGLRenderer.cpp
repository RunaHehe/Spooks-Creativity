...
static const Float _hx_array_data_fdf86abc_55[] = {
	(Float)1,
};
...
static const bool _hx_array_data_fdf86abc_57[] = {
	0,
};
...
static const Float _hx_array_data_fdf86abc_60[] = {
	(Float)0,(Float)0,
};
namespace openfl{
namespace display{
...
HXLINE( 324)			{
HXLINE( 324)				int _g = 0;
HXDLIN( 324)				while((_g < 16)){
HXLINE( 324)					_g = (_g + 1);
HXDLIN( 324)					int i = (_g - 1);
HXLINE( 326)					::lime::math::_Matrix4::Matrix4_Impl__obj::set(this->_hx___matrix,i,values->__get(i));
            				}
            			}
...
HXLINE( 519)		{
HXLINE( 519)			int _g = 0;
HXDLIN( 519)			while((_g < 16)){
HXLINE( 519)				_g = (_g + 1);
HXDLIN( 519)				int i = (_g - 1);
HXLINE( 521)				this->_hx___values[i] = ::lime::math::_Matrix4::Matrix4_Impl__obj::get(this->_hx___matrix,i);
            			}
            		}
...
HXDLIN(  57)		_hx___alphaValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_45,1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_58_boot)
HXDLIN(  58)		_hx___colorMultipliersValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_47,4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_59_boot)
HXDLIN(  59)		_hx___colorOffsetsValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_49,4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_60_boot)
HXDLIN(  60)		_hx___defaultColorMultipliersValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_51,4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_61_boot)
HXDLIN(  61)		_hx___emptyColorValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_53,4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_62_boot)
HXDLIN(  62)		_hx___emptyAlphaValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_55,1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_63_boot)
HXDLIN(  63)		_hx___hasColorTransformValue = ::Array_obj< bool >::fromData( _hx_array_data_fdf86abc_57,1);
            	}
{
...
HXDLIN(  65)		_hx___textureSizeValue = ::Array_obj< Float >::fromData( _hx_array_data_fdf86abc_60,2);
            	}
}
