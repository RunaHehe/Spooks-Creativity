...
HXLINE(  71)		{
HXLINE(  71)			int _g = 0;
HXDLIN(  71)			while((_g < 6)){
HXLINE(  71)				_g = (_g + 1);
HXDLIN(  71)				int i = (_g - 1);
HXLINE(  73)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),( (Float)(-1) ),( (Float)(1) ),null());
...
HXLINE(  78)		{
HXLINE(  78)			int _g1 = 0;
HXDLIN(  78)			while((_g1 < 15)){
HXLINE(  78)				_g1 = (_g1 + 1);
HXDLIN(  78)				int i1 = (_g1 - 1);
HXLINE(  80)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),( (Float)(0) ),( (Float)(1) ),null());
HXLINE(  81)				this->_hx___button->set(i1,control);
