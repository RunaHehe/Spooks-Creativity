...
HXDLIN(  94)				if (::hx::IsNotNull( event )) {
HXLINE(  94)					_hx_tmp4 = ::hx::IsNull( event->object );
            				}
            				else {
HXLINE(  94)					_hx_tmp4 = true;
            				}
HXDLIN(  94)				if (!(_hx_tmp4)) {
HXLINE(  94)					_hx_tmp3 = !(event->object->alive);
            				}
            				else {
...
HXLINE( 117)						_hx_tmp6 = !(over->object->visible);
            					}
            					else {
HXLINE( 117)						_hx_tmp6 = true;
            					}
HXDLIN( 117)					if (!(_hx_tmp6)) {
HXLINE( 117)						_hx_tmp5 = ::hx::IsNull( this->get(over->object,currentOverObjects) );
            					}
            					else {
...
HXLINE( 129)						_hx_tmp8 = current->object->visible;
            					}
            					else {
HXLINE( 129)						_hx_tmp8 = false;
            					}
HXDLIN( 129)					if (_hx_tmp8) {
HXLINE( 129)						_hx_tmp7 = ::hx::IsNull( this->get(current->object,this->_overList) );
            					}
            					else {
...
HXLINE( 143)			_hx_tmp9 = (_this->_prevY != _this->y);
            		}
            		else {
HXLINE( 143)			_hx_tmp9 = true;
            		}
...
HXDLIN( 147)				bool _hx_tmp11;
HXDLIN( 147)				if (::hx::IsNotNull( current1->onMouseMove )) {
HXLINE( 147)					_hx_tmp11 = current1->object->exists;
            				}
            				else {
HXLINE( 147)					_hx_tmp11 = false;
            				}
HXDLIN( 147)				if (_hx_tmp11) {
HXLINE( 147)					_hx_tmp10 = current1->object->visible;
            				}
            				else {
...
HXLINE( 157)				bool _hx_tmp12;
HXDLIN( 157)				bool _hx_tmp13;
HXDLIN( 157)				if (::hx::IsNotNull( current2->onMouseDown )) {
HXLINE( 157)					_hx_tmp13 = current2->object->exists;
            				}
            				else {
HXLINE( 157)					_hx_tmp13 = false;
            				}
HXDLIN( 157)				if (_hx_tmp13) {
HXLINE( 157)					_hx_tmp12 = current2->object->visible;
            				}
            				else {
HXLINE( 157)					_hx_tmp12 = false;
            				}
HXDLIN( 157)				if (_hx_tmp12) {
...
HXLINE( 174)				bool _hx_tmp14;
HXDLIN( 174)				bool _hx_tmp15;
HXDLIN( 174)				bool _hx_tmp16;
HXDLIN( 174)				if (::hx::IsNull( current3->onMouseClick )) {
HXLINE( 174)					_hx_tmp16 = ::hx::IsNotNull( current3->onMouseDoubleClick );
            				}
            				else {
HXLINE( 174)					_hx_tmp16 = true;
            				}
HXDLIN( 174)				if (_hx_tmp16) {
HXLINE( 174)					_hx_tmp15 = current3->object->exists;
            				}
            				else {
HXLINE( 174)					_hx_tmp15 = false;
            				}
HXDLIN( 174)				if (_hx_tmp15) {
HXLINE( 174)					_hx_tmp14 = current3->object->visible;
            				}
            				else {
HXLINE( 174)					_hx_tmp14 = false;
            				}
...
HXLINE( 186)				bool _hx_tmp17;
HXDLIN( 186)				bool _hx_tmp18;
HXDLIN( 186)				if (::hx::IsNotNull( current4->onMouseUp )) {
HXLINE( 186)					_hx_tmp18 = current4->object->exists;
            				}
            				else {
HXLINE( 186)					_hx_tmp18 = false;
            				}
HXDLIN( 186)				if (_hx_tmp18) {
HXLINE( 186)					_hx_tmp17 = current4->object->visible;
            				}
            				else {
HXLINE( 186)					_hx_tmp17 = false;
            				}
HXDLIN( 186)				if (_hx_tmp17) {
...
HXLINE( 200)		bool _hx_tmp19;
HXDLIN( 200)		if ((this->_clickList->length > 0)) {
HXLINE( 200)			_hx_tmp19 = ((::flixel::FlxG_obj::game->ticks - this->mouseClickedTime) > this->maxDoubleClickDelay);
            		}
            		else {
...
HXDLIN( 218)					bool _hx_tmp22;
HXDLIN( 218)					if (::hx::IsNotNull( down->object )) {
HXLINE( 218)						_hx_tmp22 = down->object->exists;
            					}
            					else {
HXLINE( 218)						_hx_tmp22 = false;
            					}
HXDLIN( 218)					if (_hx_tmp22) {
HXLINE( 218)						_hx_tmp21 = down->object->visible;
            					}
            					else {
HXLINE( 218)						_hx_tmp21 = false;
            					}
HXDLIN( 218)					if (_hx_tmp21) {
HXLINE( 218)						_hx_tmp20 = ::hx::IsNotNull( this->get(down->object,currentOverObjects) );
            					}
            					else {
...
HXDLIN( 243)			bool _hx_tmp24;
HXDLIN( 243)			if ((_this1->current != 1)) {
HXLINE( 243)				_hx_tmp24 = (_this1->current == 2);
            			}
            			else {
HXLINE( 243)				_hx_tmp24 = true;
            			}
HXDLIN( 243)			_hx_tmp23 = !(_hx_tmp24);
            		}
            		else {
HXLINE( 243)			_hx_tmp23 = false;
            		}
HXDLIN( 243)		if (_hx_tmp23) {
...
HXLINE( 254)				bool _hx_tmp25;
HXDLIN( 254)				bool _hx_tmp26;
HXDLIN( 254)				if (::hx::IsNotNull( current5->onMouseWheel )) {
HXLINE( 254)					_hx_tmp26 = current5->object->exists;
            				}
            				else {
HXLINE( 254)					_hx_tmp26 = false;
            				}
HXDLIN( 254)				if (_hx_tmp26) {
HXLINE( 254)					_hx_tmp25 = current5->object->visible;
            				}
            				else {
HXLINE( 254)					_hx_tmp25 = false;
            				}
HXDLIN( 254)				if (_hx_tmp25) {
