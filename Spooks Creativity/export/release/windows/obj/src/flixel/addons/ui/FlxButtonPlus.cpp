...
HXLINE( 331)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp2 = this->buttonNormal;
...
HXLINE( 370)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp2 = this->buttonHighlight;
