...
HXLINE( 598)				 ::Dynamic _hx_tmp1 = this->mousePressedCallback;
HXDLIN( 598)				int _hx_tmp2 = this->get_mouseX();
HXDLIN( 598)				_hx_tmp1(::hx::ObjectPtr<OBJ_>(this),_hx_tmp2,this->get_mouseY());
            			}
            		}
HXLINE( 602)		bool _hx_tmp3;
HXDLIN( 602)		if (this->draggable) {
HXLINE( 602)			_hx_tmp3 = this->isOverPixelPerfect(mouse,this->_dragPixelPerfect,this->_dragPixelPerfectAlpha);
            		}
            		else {
...
HXLINE( 639)				 ::Dynamic _hx_tmp3 = this->mouseReleasedCallback;
HXDLIN( 639)				int _hx_tmp4 = this->get_mouseX();
HXDLIN( 639)				_hx_tmp3(::hx::ObjectPtr<OBJ_>(this),_hx_tmp4,this->get_mouseY());
            			}
            		}
            	}
...
HXLINE( 688)				 ::flixel::math::FlxRect _this1 = this->boundsRect;
HXDLIN( 688)				Float _hx_tmp2 = (_this1->x + _this1->width);
HXDLIN( 688)				this->set_x((_hx_tmp2 - this->get_width()));
            			}
            		}
...
HXLINE( 695)			Float _hx_tmp3 = this->y;
HXDLIN( 695)			Float _hx_tmp4 = (_hx_tmp3 + this->get_height());
HXDLIN( 695)			 ::flixel::math::FlxRect _this2 = this->boundsRect;
HXDLIN( 695)			if ((_hx_tmp4 > (_this2->y + _this2->height))) {
HXLINE( 697)				 ::flixel::math::FlxRect _this3 = this->boundsRect;
HXDLIN( 697)				Float _hx_tmp5 = (_this3->y + _this3->height);
HXDLIN( 697)				this->set_y((_hx_tmp5 - this->get_height()));
            			}
            		}
            	}
...
HXLINE( 712)				Float _hx_tmp3 = this->boundsSprite->x;
HXDLIN( 712)				Float _hx_tmp4 = (_hx_tmp3 + this->boundsSprite->get_width());
HXDLIN( 712)				this->set_x((_hx_tmp4 - this->get_width()));
            			}
            		}
...
HXLINE( 719)			Float _hx_tmp5 = this->y;
HXDLIN( 719)			Float _hx_tmp6 = (_hx_tmp5 + this->get_height());
HXDLIN( 719)			Float _hx_tmp7 = this->boundsSprite->y;
HXDLIN( 719)			if ((_hx_tmp6 > (_hx_tmp7 + this->boundsSprite->get_height()))) {
HXLINE( 721)				Float _hx_tmp8 = this->boundsSprite->y;
HXDLIN( 721)				Float _hx_tmp9 = (_hx_tmp8 + this->boundsSprite->get_height());
HXDLIN( 721)				this->set_y((_hx_tmp9 - this->get_height()));
            			}
            		}
            	}
