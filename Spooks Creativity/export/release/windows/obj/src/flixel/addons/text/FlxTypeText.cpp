...
HX_DEFINE_STACK_FRAME(_hx_pos_09182b6b580f8cf2_28_new,"flixel.addons.text.FlxTypeText","new",0x24edf2f3,"flixel.addons.text.FlxTypeText.new","flixel/addons/text/FlxTypeText.hx",28,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_196_start,"flixel.addons.text.FlxTypeText","start",0x9d61a1b5,"flixel.addons.text.FlxTypeText.start","flixel/addons/text/FlxTypeText.hx",196,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_234_applyMarkup,"flixel.addons.text.FlxTypeText","applyMarkup",0x7596b149,"flixel.addons.text.FlxTypeText.applyMarkup","flixel/addons/text/FlxTypeText.hx",234,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_245_insertBreakLines,"flixel.addons.text.FlxTypeText","insertBreakLines",0x530ffae6,"flixel.addons.text.FlxTypeText.insertBreakLines","flixel/addons/text/FlxTypeText.hx",245,0x9451ed7e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_160_boot,"flixel.addons.text.FlxTypeText","boot",0x235fa23f,"flixel.addons.text.FlxTypeText.boot","flixel/addons/text/FlxTypeText.hx",160,0x9451ed7e)
namespace flixel{
namespace addons{
namespace text{
...
void FlxTypeText_obj::__construct(Float X,Float Y,int Width,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_28_new)
HXLINE( 155)		this->_typeVarPercent = ((Float)0.5);
HXLINE( 150)		this->_typingVariation = false;
HXLINE( 145)		this->_cursorTimer = ((Float)0.0);
HXLINE( 140)		this->_waiting = false;
HXLINE( 135)		this->_erasing = false;
HXLINE( 130)		this->_typing = false;
HXLINE( 125)		this->_length = 0;
HXLINE( 120)		this->_waitTimer = ((Float)0.0);
HXLINE( 115)		this->_timer = ((Float)0.0);
HXLINE( 110)		this->_finalText = HX_("",00,00,00,00);
HXLINE(  95)		this->skipKeys = ::Array_obj< int >::__new(0);
HXLINE(  90)		this->finishSounds = false;
HXLINE(  83)		this->useDefaultSound = false;
HXLINE(  73)		this->paused = false;
HXLINE(  68)		this->waitTime = ((Float)1.0);
HXLINE(  63)		this->autoErase = false;
HXLINE(  58)		this->prefix = HX_("",00,00,00,00);
HXLINE(  53)		this->cursorBlinkSpeed = ((Float)0.5);
HXLINE(  48)		this->cursorCharacter = HX_("|",7c,00,00,00);
HXLINE(  43)		this->showCursor = false;
HXLINE(  38)		this->eraseDelay = ((Float)0.02);
HXLINE(  33)		this->delay = ((Float)0.05);
HXLINE( 180)		super::__construct(X,Y,Width,HX_("",00,00,00,00),Size,EmbeddedFont);
HXLINE( 181)		this->_finalText = Text;
            	}
...
void FlxTypeText_obj::start( ::Dynamic Delay,::hx::Null< bool >  __o_ForceRestart,::hx::Null< bool >  __o_AutoErase,::Array< int > SkipKeys, ::Dynamic Callback){
            	...
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_196_start)
HXLINE( 197)		if (::hx::IsNotNull( Delay )) {
HXLINE( 199)			this->delay = ( (Float)(Delay) );
            		}
HXLINE( 202)		this->_typing = true;
HXLINE( 203)		this->_erasing = false;
HXLINE( 204)		this->paused = false;
HXLINE( 205)		this->_waiting = false;
HXLINE( 207)		if (ForceRestart) {
HXLINE( 209)			this->set_text(HX_("",00,00,00,00));
HXLINE( 210)			this->_length = 0;
            		}
HXLINE( 213)		this->autoErase = AutoErase;
HXLINE( 215)		if (::hx::IsNotNull( SkipKeys )) {
HXLINE( 217)			this->skipKeys = SkipKeys;
            		}
HXLINE( 220)		if (::hx::IsNotNull( Callback )) {
HXLINE( 222)			this->completeCallback = Callback;
            		}
HXLINE( 225)		this->insertBreakLines();
HXLINE( 227)		if (this->useDefaultSound) {
HXLINE( 229)			this->loadDefaultSound();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTypeText_obj,start,(void))
 ...
 ::flixel::text::FlxText FlxTypeText_obj::applyMarkup(::String input,::Array< ::Dynamic> rules){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_234_applyMarkup)
HXLINE( 235)		this->super::applyMarkup(input,rules);
HXLINE( 236)		this->resetText(this->text);
HXLINE( 237)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


void FlxTypeText_obj::insertBreakLines(){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_245_insertBreakLines)
HXLINE( 246)		::String saveText = this->text;
HXLINE( 248)		int last = this->_finalText.length;
HXLINE( 249)		int n0 = 0;
HXLINE( 250)		int n1 = 0;
HXLINE( 252)		while(true){
HXLINE( 254)			last = this->_finalText.substr(0,last).lastIndexOf(HX_(" ",20,00,00,00),null());
HXLINE( 256)			if ((last <= 0)) {
HXLINE( 257)				goto _hx_goto_3;
            			}
HXLINE( 259)			this->set_text((this->prefix + this->_finalText));
HXLINE( 260)			n0 = this->textField->get_numLines();
HXLINE( 262)			::String nextText = (this->_finalText.substr(0,last) + HX_("\n",0a,00,00,00));
HXDLIN( 262)			::String nextText1 = (nextText + this->_finalText.substr((last + 1),this->_finalText.length));
HXLINE( 264)			this->set_text((this->prefix + nextText1));
HXLINE( 265)			n1 = this->textField->get_numLines();
HXLINE( 267)			if ((n0 == n1)) {
HXLINE( 269)				this->_finalText = nextText1;
            			}
            		}
            		_hx_goto_3:;
HXLINE( 273)		this->set_text(saveText);
            	}
...
HXLINE( 355)			 ::flixel::sound::FlxSound _this = this->_sound;
...
HXLINE( 359)					 ::flixel::sound::FlxSound sound = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 359)					_g = (_g + 1);
...
HXLINE( 467)							 ::flixel::sound::FlxSound sound = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 467)							_g = (_g + 1);
HXLINE( 469)							sound->cleanup(sound->autoDestroy,true);
            						}
            					}
HXLINE( 473)					::flixel::FlxG_obj::random->getObject_flixel_sound_FlxSound(this->sounds,null(),null(),null())->play(!(this->finishSounds),null(),null());
            				}
            				else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_160_boot)
HXDLIN( 160)		helperString = HX_("",00,00,00,00);
            	}
}
