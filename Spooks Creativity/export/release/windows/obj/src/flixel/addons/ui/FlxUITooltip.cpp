...
HXLINE( 455)			{
HXLINE( 455)				int _g = 0;
HXDLIN( 455)				while((_g < 3)){
HXLINE( 455)					_g = (_g + 1);
HXDLIN( 455)					int yy = (_g - 1);
HXLINE( 457)					{
HXLINE( 457)						int _g1 = 0;
HXDLIN( 457)						while((_g1 < 3)){
HXLINE( 457)							_g1 = (_g1 + 1);
HXDLIN( 457)							int xx = (_g1 - 1);
HXLINE( 459)							bool _hx_tmp1;
HXDLIN( 459)							if ((yy == 1)) {
HXLINE( 459)								_hx_tmp1 = (xx != 1);
            							}
            							else {
HXLINE( 459)								_hx_tmp1 = true;
            							}
HXDLIN( 459)							if (_hx_tmp1) {
HXLINE( 461)								b->stamp(this->_arrow,(xx * ( (int)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )),(yy * ( (int)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )));
            							}
            						}
            					}
            				}
