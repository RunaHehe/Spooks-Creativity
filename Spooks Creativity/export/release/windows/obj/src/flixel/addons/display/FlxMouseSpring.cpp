...
HXLINE(  76)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  76)			point1->_inPool = false;
HXDLIN(  76)			 ::flixel::math::FlxBasePoint this1 = point1;
HXDLIN(  76)			{
...
HXDLIN(  82)				Float y1 = ( (Float)(extSprite->springOffsetY) );
HXDLIN(  82)				 ::flixel::math::FlxBasePoint point11 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y1);
HXDLIN(  82)				point11->_inPool = false;
HXDLIN(  82)				this->offset = point11;
            			}
            		}
            	}
