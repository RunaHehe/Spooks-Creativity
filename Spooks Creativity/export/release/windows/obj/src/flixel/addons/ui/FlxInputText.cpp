...
HXLINE( 365)						_hx_tmp2 = ((this->text.length + newText.length) < this->maxLength);
            					}
            					else {
...
HXLINE( 435)										::String _hx_tmp7 = this->text.substring(0,this->caretIndex);
HXDLIN( 435)										this->set_text((_hx_tmp7 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 442)											_hx_tmp8 = (this->caretIndex < this->text.length);
            										}
            										else {
HXLINE( 442)											_hx_tmp8 = false;
            										}
HXDLIN( 442)										if (_hx_tmp8) {
HXLINE( 444)											::String _hx_tmp9 = this->text.substring(0,this->caretIndex);
HXDLIN( 444)											this->set_text((_hx_tmp9 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 460)											::String newText1 = this->filter(::String::fromCharCode(e->charCode));
HXLINE( 462)											bool _hx_tmp10;
HXDLIN( 462)											if ((newText1.length > 0)) {
HXLINE( 462)												if ((this->maxLength != 0)) {
HXLINE( 462)													_hx_tmp10 = ((this->text.length + newText1.length) < this->maxLength);
            												}
            												else {
HXLINE( 462)													_hx_tmp10 = true;
            												}
            											}
            											else {
HXLINE( 462)												_hx_tmp10 = false;
            											}
HXDLIN( 462)											if (_hx_tmp10) {
HXLINE( 464)												this->set_text(this->insertSubstring(this->text,newText1,this->caretIndex));
...
HXDLIN( 509)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 509)		point->_inPool = false;
HXDLIN( 509)		 ::flixel::math::FlxBasePoint hit = point;
...
HXLINE( 527)				 ::flixel::math::FlxRect _this1 = this->_charBoundaries->__get(charIndex).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 527)				 ::openfl::geom::Rectangle FlashRect1 = r;
HXDLIN( 527)				if (::hx::IsNull( FlashRect1 )) {
HXLINE( 527)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 527)				FlashRect1->x = _this1->x;
HXDLIN( 527)				FlashRect1->y = _this1->y;
HXDLIN( 527)				FlashRect1->width = _this1->width;
HXDLIN( 527)				FlashRect1->height = _this1->height;
            			}
HXLINE( 529)			return r;
            		}
...
HXLINE( 591)			Float _hx_tmp1 = this->textField->get_textWidth();
HXDLIN( 591)			if ((_hx_tmp1 <= this->textField->get_width())) {
...
HXLINE( 596)					Float X2 = (X - this->textField->get_width());
HXDLIN( 596)					X = (X2 + this->textField->get_textWidth());
...
HXDLIN( 611)				if ((X >= r->x)) {
HXLINE( 611)					_hx_tmp2 = (X <= (r->x + r->width));
            				}
            				else {
...
HXLINE( 620)			_hx_tmp3 = (this->_charBoundaries->length > 0);
            		}
            		else {
...
HXDLIN( 648)			int _g3 = numChars;
HXDLIN( 648)			while((_g2 < _g3)){
HXLINE( 648)				_g2 = (_g2 + 1);
HXDLIN( 648)				int i1 = (_g2 - 1);
HXLINE( 650)				if (((this->_charBoundaries->length - 1) < i1)) {
HXLINE( 652)					::Array< ::Dynamic> _hx_tmp = this->_charBoundaries;
HXDLIN( 652)					 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 682)				Float _hx_tmp2 = boundary->get_left();
HXDLIN( 682)				if ((_hx_tmp2 < this->lastScroll)) {
...
HXLINE( 726)				 ::flixel::FlxSprite _hx_tmp5 = this->backgroundSprite;
HXDLIN( 726)				int _hx_tmp6 = ::Std_obj::_hx_int(this->get_width());
HXDLIN( 726)				int _hx_tmp7 = ::Std_obj::_hx_int(this->get_height());
HXDLIN( 726)				_hx_tmp5->makeGraphic(_hx_tmp6,_hx_tmp7,this->backgroundColor,null(),null());
...
HXLINE( 755)					{
HXLINE( 755)						 ::flixel::math::FlxBasePoint this1 = this->caret->offset;
HXDLIN( 755)						this1->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
            				case (int)1: {
...
HXLINE( 766)					{
HXLINE( 766)						 ::flixel::math::FlxBasePoint this2 = this->caret->offset;
HXDLIN( 766)						this2->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
...
HXLINE( 773)					Float r4 = this->borderSize;
HXDLIN( 773)					Float r5 = this->borderSize;
HXDLIN( 773)					int r6 = this->caretWidth;
HXDLIN( 773)					 ::openfl::geom::Rectangle r7 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
HXLINE( 774)					this->caret->get_pixels()->fillRect(r7,caretC);
HXLINE( 776)					{
HXLINE( 776)						 ::flixel::math::FlxBasePoint this3 = this->caret->offset;
HXDLIN( 776)						this3->set_x(this->caret->offset->set_y(this->borderSize));
            					}
            				}
            				break;
            			}
...
HXLINE( 821)					pattern = this->customFilterPattern;
            				...
            				break;
            				default:{
HXLINE( 823)					HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,((HX_("FlxInputText: Unknown filterMode (",04,c7,17,56) + this->filterMode) + HX_(")",29,00,00,00)),null()));
            				}
            			}
...
HXLINE( 919)			goto _hx_goto_31;
            		...
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 915)			Float offx3 = (this->textField->get_width() - ( (Float)(2) ));
HXDLIN( 915)			offx = ((offx3 - this->textField->get_textWidth()) - ( (Float)(2) ));
...
HXLINE( 959)					 ::flixel::FlxSprite _hx_tmp4 = this->caret;
HXDLIN( 959)					Float _hx_tmp5 = (offx + boundaries->get_right());
HXDLIN( 959)					_hx_tmp4->set_x((_hx_tmp5 + this->x));
HXLINE( 960)					 ::flixel::FlxSprite _hx_tmp6 = this->caret;
HXDLIN( 960)					Float _hx_tmp7 = boundaries->get_top();
HXDLIN( 960)					_hx_tmp6->set_y((_hx_tmp7 + this->y));
            				}
            				else {
...
HXLINE( 977)		bool _hx_tmp8;
HXDLIN( 977)		if ((this->lines == 1)) {
HXLINE( 977)			Float _hx_tmp9 = this->caret->x;
HXDLIN( 977)			Float _hx_tmp10 = (_hx_tmp9 + this->caret->get_width());
HXDLIN( 977)			Float _hx_tmp11 = this->x;
HXDLIN( 977)			_hx_tmp8 = (_hx_tmp10 > (_hx_tmp11 + this->get_width()));
            		}
            		else {
HXLINE( 977)			_hx_tmp8 = false;
            		}
HXDLIN( 977)		if (_hx_tmp8) {
HXLINE( 979)			 ::flixel::FlxSprite _hx_tmp12 = this->caret;
HXDLIN( 979)			Float _hx_tmp13 = this->x;
HXDLIN( 979)			_hx_tmp12->set_x(((_hx_tmp13 + this->get_width()) - ( (Float)(2) )));
            		}
