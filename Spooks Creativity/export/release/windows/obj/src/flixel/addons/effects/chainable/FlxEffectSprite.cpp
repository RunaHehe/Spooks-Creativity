...
HXLINE(  60)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 137)			_hx_tmp = (this->target->animation->_sprite->get_numFrames() > 1);
            		}
            		else {
