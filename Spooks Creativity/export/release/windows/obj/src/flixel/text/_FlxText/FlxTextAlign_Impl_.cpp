...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1177_fromOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1177,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1189_toOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1189,0xdf165a6e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1173_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1173,0xdf165a6e)
namespace flixel{
namespace text{
namespace _FlxText{
...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1177_fromOpenFL)
HXDLIN(1177)		 ::Dynamic _hx_switch_0 = align;
            		if (  (_hx_switch_0==0) ){
HXLINE(1180)			return HX_("center",d5,25,db,05);
HXDLIN(1180)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1182)			return HX_("justify",50,df,b5,83);
HXDLIN(1182)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(1179)			return HX_("left",07,08,b0,47);
HXDLIN(1179)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==4) ){
HXLINE(1181)			return HX_("right",dc,0b,64,e9);
HXDLIN(1181)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(1183)			return HX_("left",07,08,b0,47);
            		}
            		_hx_goto_0:;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1189_toOpenFL)
HXDLIN(1189)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1192)			return 0;
HXDLIN(1192)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1194)			return 2;
HXDLIN(1194)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1191)			return 3;
HXDLIN(1191)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1193)			return 4;
HXDLIN(1193)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(1195)			return 3;
            		}
            		_hx_goto_2:;
HXLINE(1189)		return null();
            	}
...
HXDLIN(1163)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1170_boot)
HXDLIN(1170)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1172_boot)
HXDLIN(1172)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1173_boot)
HXDLIN(1173)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
