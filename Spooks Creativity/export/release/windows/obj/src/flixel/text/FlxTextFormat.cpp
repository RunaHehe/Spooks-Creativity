...
HX_DEFINE_STACK_FRAME(_hx_pos_a69907c6a733237a_1103_new,"flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",1103,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_a69907c6a733237a_1109_set_leading,"flixel.text.FlxTextFormat","set_leading",0x68682d02,"flixel.text.FlxTextFormat.set_leading","flixel/text/FlxText.hx",1109,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormat_obj::__construct( ::Dynamic FontColor, ::Dynamic Bold, ::Dynamic Italic, ::Dynamic BorderColor){
            	HX_GC_STACKFRAME(&_hx_pos_a69907c6a733237a_1103_new)
HXLINE(1104)		this->format =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),FontColor,Bold,Italic,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(1105)		int _hx_tmp;
HXDLIN(1105)		if (::hx::IsNull( BorderColor )) {
HXLINE(1105)			_hx_tmp = 0;
            		}
            		else {
HXLINE(1105)			_hx_tmp = ( (int)(BorderColor) );
            		}
HXDLIN(1105)		this->borderColor = _hx_tmp;
            	}
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_STACKFRAME(&_hx_pos_a69907c6a733237a_1109_set_leading)
HXLINE(1110)		this->format->leading = value;
