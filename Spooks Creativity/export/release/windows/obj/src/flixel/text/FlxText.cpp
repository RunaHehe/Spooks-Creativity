...
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_849_drawTextFieldTo,"flixel.text.FlxText","drawTextFieldTo",0xda5cac46,"flixel.text.FlxText.drawTextFieldTo","flixel/text/FlxText.hx",849,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_905_draw,"flixel.text.FlxText","draw",0x3a66d282,"flixel.text.FlxText.draw","flixel/text/FlxText.hx",905,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_916_calcFrame,"flixel.text.FlxText","calcFrame",0x04b3a41a,"flixel.text.FlxText.calcFrame","flixel/text/FlxText.hx",916,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_928_applyBorderStyle,"flixel.text.FlxText","applyBorderStyle",0x7fb82955,"flixel.text.FlxText.applyBorderStyle","flixel/text/FlxText.hx",928,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_994_applyBorderTransparency,"flixel.text.FlxText","applyBorderTransparency",0x59c1b674,"flixel.text.FlxText.applyBorderTransparency","flixel/text/FlxText.hx",994,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1010_copyTextWithOffset,"flixel.text.FlxText","copyTextWithOffset",0x8b535ed9,"flixel.text.FlxText.copyTextWithOffset","flixel/text/FlxText.hx",1010,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1017_applyFormats,"flixel.text.FlxText","applyFormats",0x597a620c,"flixel.text.FlxText.applyFormats","flixel/text/FlxText.hx",1017,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1043_copyTextFormat,"flixel.text.FlxText","copyTextFormat",0xce0953d7,"flixel.text.FlxText.copyTextFormat","flixel/text/FlxText.hx",1043,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1060_dtfCopy,"flixel.text.FlxText","dtfCopy",0x79c34ded,"flixel.text.FlxText.dtfCopy","flixel/text/FlxText.hx",1060,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1066_updateDefaultFormat,"flixel.text.FlxText","updateDefaultFormat",0x3cb6b251,"flixel.text.FlxText.updateDefaultFormat","flixel/text/FlxText.hx",1066,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_7d9cf70d988be490_1073_set_frames,"flixel.text.FlxText","set_frames",0x579256e1,"flixel.text.FlxText.set_frames","flixel/text/FlxText.hx",1073,0xdf165a6e)
...
HXLINE( 211)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(1,1);
...
HXLINE( 789)		int newWidth = ::Math_obj::ceil(this->textField->get_width());
HXLINE( 791)		int newHeight = (::Math_obj::ceil(this->textField->get_textHeight()) + 4);
...
HXLINE( 802)			this->set_height(( (Float)(newHeight) ));
HXLINE( 803)			::String key = ::flixel::FlxG_obj::bitmap->getUniqueKey(HX_("text",ad,cc,f9,4c));
HXLINE( 804)			this->makeGraphic(newWidth,newHeight,0,false,key);
HXLINE( 806)			if (this->_hasBorderAlpha) {
HXLINE( 807)				this->_borderPixels = this->graphic->bitmap->clone();
            			}
HXLINE( 808)			this->frameHeight = newHeight;
HXLINE( 809)			 ::openfl::text::TextField _hx_tmp2 = this->textField;
HXDLIN( 809)			_hx_tmp2->set_height((this->get_height() * ((Float)1.2)));
HXLINE( 810)			this->_flashRect->x = ( (Float)(0) );
HXLINE( 811)			this->_flashRect->y = ( (Float)(0) );
HXLINE( 812)			this->_flashRect->width = ( (Float)(newWidth) );
HXLINE( 813)			this->_flashRect->height = ( (Float)(newHeight) );
            		}
            		else {
...
void FlxText_obj::drawTextFieldTo( ::openfl::display::BitmapData graphic){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_849_drawTextFieldTo)
HXLINE( 877)		this->_matrix->translate(( (Float)(-1) ),( (Float)(-1) ));
HXLINE( 878)		graphic->draw(this->textField,this->_matrix,null(),null(),null(),null());
HXLINE( 879)		this->_matrix->translate(( (Float)(1) ),( (Float)(1) ));
            	}
...
void FlxText_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_905_draw)
HXLINE( 906)		this->regenGraphic();
HXLINE( 907)		this->super::draw();
            	}


void FlxText_obj::calcFrame(::hx::Null< bool >  __o_RunOnCpp){
            		bool RunOnCpp = __o_RunOnCpp.Default(false);
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_916_calcFrame)
HXLINE( 917)		if (::hx::IsNull( this->textField )) {
HXLINE( 918)			return;
            		}
HXLINE( 920)		bool _hx_tmp;
HXDLIN( 920)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 920)			_hx_tmp = !(RunOnCpp);
            		}
            		else {
...
HXLINE( 923)		this->regenGraphic();
HXLINE( 924)		this->super::calcFrame(RunOnCpp);
            	}


void FlxText_obj::applyBorderStyle(){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_928_applyBorderStyle)
HXLINE( 929)		int iterations = ::Std_obj::_hx_int((this->borderSize * this->borderQuality));
HXLINE( 930)		if ((iterations <= 0)) {
HXLINE( 932)			iterations = 1;
            		}
HXLINE( 934)		Float delta = (this->borderSize / ( (Float)(iterations) ));
HXLINE( 936)		switch((int)(this->borderStyle->_hx_getIndex())){
            			case (int)0: {
            			}
            			break;
            			case (int)1: {
HXLINE( 941)				this->applyFormats(this->_formatAdjusted,true);
HXLINE( 943)				{
HXLINE( 943)					int _g = 0;
HXDLIN( 943)					int _g1 = iterations;
HXDLIN( 943)					while((_g < _g1)){
HXLINE( 943)						_g = (_g + 1);
HXDLIN( 943)						int i = (_g - 1);
HXLINE( 945)						{
HXLINE( 945)							 ::openfl::display::BitmapData graphic;
HXDLIN( 945)							if (this->_hasBorderAlpha) {
HXLINE( 945)								graphic = this->_borderPixels;
            							}
            							else {
HXLINE( 945)								graphic = this->graphic->bitmap;
            							}
HXDLIN( 945)							this->_matrix->translate(delta,delta);
HXDLIN( 945)							this->drawTextFieldTo(graphic);
            						}
            					}
            				}
HXLINE( 948)				this->_matrix->translate((-(this->shadowOffset->x) * this->borderSize),(-(this->shadowOffset->y) * this->borderSize));
            			}
            			break;
            			case (int)2: {
HXLINE( 953)				this->applyFormats(this->_formatAdjusted,true);
HXLINE( 955)				Float curDelta = delta;
HXLINE( 956)				{
HXLINE( 956)					int _g2 = 0;
HXDLIN( 956)					int _g3 = iterations;
HXDLIN( 956)					while((_g2 < _g3)){
HXLINE( 956)						_g2 = (_g2 + 1);
HXDLIN( 956)						int i1 = (_g2 - 1);
HXLINE( 958)						{
...
HXDLIN( 958)							this->_matrix->translate(-(curDelta),-(curDelta));
...
HXDLIN( 960)							this->_matrix->translate(curDelta,( (Float)(0) ));
...
HXDLIN( 962)							this->_matrix->translate(( (Float)(0) ),curDelta);
...
HXDLIN( 964)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN( 964)							this->drawTextFieldTo(graphic7);
            						}
HXLINE( 965)						{
HXLINE( 965)							 ::openfl::display::BitmapData graphic8;
HXDLIN( 965)							if (this->_hasBorderAlpha) {
HXLINE( 965)								graphic8 = this->_borderPixels;
            							}
            							else {
HXLINE( 965)								graphic8 = this->graphic->bitmap;
            							}
HXDLIN( 965)							this->_matrix->translate(( (Float)(0) ),-(curDelta));
HXDLIN( 965)							this->drawTextFieldTo(graphic8);
            						}
HXLINE( 967)						this->_matrix->translate(curDelta,( (Float)(0) ));
HXLINE( 968)						curDelta = (curDelta + delta);
            					}
            				}
            			}
            			break;
            			case (int)3: {
HXLINE( 975)				this->applyFormats(this->_formatAdjusted,true);
HXLINE( 977)				Float curDelta1 = delta;
HXLINE( 978)				{
HXLINE( 978)					int _g4 = 0;
HXDLIN( 978)					int _g5 = iterations;
HXDLIN( 978)					while((_g4 < _g5)){
HXLINE( 978)						_g4 = (_g4 + 1);
HXDLIN( 978)						int i2 = (_g4 - 1);
HXLINE( 980)						{
HXLINE( 980)							 ::openfl::display::BitmapData graphic9;
HXDLIN( 980)							if (this->_hasBorderAlpha) {
HXLINE( 980)								graphic9 = this->_borderPixels;
            							}
            							else {
HXLINE( 980)								graphic9 = this->graphic->bitmap;
            							}
HXDLIN( 980)							this->_matrix->translate(-(curDelta1),-(curDelta1));
HXDLIN( 980)							this->drawTextFieldTo(graphic9);
            						}
HXLINE( 981)						{
HXLINE( 981)							 ::openfl::display::BitmapData graphic10;
HXDLIN( 981)							if (this->_hasBorderAlpha) {
HXLINE( 981)								graphic10 = this->_borderPixels;
            							}
            							else {
HXLINE( 981)								graphic10 = this->graphic->bitmap;
            							}
HXDLIN( 981)							this->_matrix->translate((curDelta1 * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 981)							this->drawTextFieldTo(graphic10);
            						}
HXLINE( 982)						{
HXLINE( 982)							 ::openfl::display::BitmapData graphic11;
HXDLIN( 982)							if (this->_hasBorderAlpha) {
HXLINE( 982)								graphic11 = this->_borderPixels;
            							}
            							else {
HXLINE( 982)								graphic11 = this->graphic->bitmap;
            							}
HXDLIN( 982)							this->_matrix->translate(( (Float)(0) ),(curDelta1 * ( (Float)(2) )));
HXDLIN( 982)							this->drawTextFieldTo(graphic11);
            						}
HXLINE( 983)						{
HXLINE( 983)							 ::openfl::display::BitmapData graphic12;
HXDLIN( 983)							if (this->_hasBorderAlpha) {
HXLINE( 983)								graphic12 = this->_borderPixels;
            							}
            							else {
HXLINE( 983)								graphic12 = this->graphic->bitmap;
            							}
HXDLIN( 983)							this->_matrix->translate((-(curDelta1) * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 983)							this->drawTextFieldTo(graphic12);
            						}
HXLINE( 985)						this->_matrix->translate(curDelta1,-(curDelta1));
HXLINE( 986)						curDelta1 = (curDelta1 + delta);
            					}
            				}
            			}
            			break;
...
void FlxText_obj::applyBorderTransparency(){
            	HX_GC_STACKFRAME(&_hx_pos_7d9cf70d988be490_994_applyBorderTransparency)
HXLINE( 995)		if (!(this->_hasBorderAlpha)) {
HXLINE( 996)			return;
            		}
HXLINE( 998)		if (::hx::IsNull( this->_borderColorTransform )) {
HXLINE( 999)			this->_borderColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE(1001)		this->_borderColorTransform->alphaMultiplier = (( (Float)(((this->borderColor >> 24) & 255)) ) / ( (Float)(255) ));
HXLINE(1002)		this->_borderPixels->colorTransform(this->_borderPixels->rect,this->_borderColorTransform);
HXLINE(1003)		this->graphic->bitmap->draw(this->_borderPixels,null(),null(),null(),null(),null());
            	}
...
void FlxText_obj::copyTextWithOffset(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_1010_copyTextWithOffset)
...
HXLINE(1012)		this->_matrix->translate(x,y);
HXLINE(1013)		this->drawTextFieldTo(graphic);
            	}
...
void FlxText_obj::applyFormats( ::openfl::text::TextFormat FormatAdjusted,::hx::Null< bool >  __o_UseBorderColor){
            	...
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_1017_applyFormats)
HXLINE(1019)		this->copyTextFormat(this->_defaultFormat,FormatAdjusted,false);
HXLINE(1020)		 ::Dynamic _hx_tmp;
HXDLIN(1020)		if (UseBorderColor) {
HXLINE(1020)			_hx_tmp = (this->borderColor & 16777215);
            		}
            		else {
HXLINE(1020)			_hx_tmp = this->_defaultFormat->color;
            		}
HXDLIN(1020)		FormatAdjusted->color = _hx_tmp;
HXLINE(1021)		this->textField->setTextFormat(FormatAdjusted,null(),null());
HXLINE(1024)		{
HXLINE(1024)			int _g = 0;
HXDLIN(1024)			::Array< ::Dynamic> _g1 = this->_formatRanges;
HXDLIN(1024)			while((_g < _g1->length)){
HXLINE(1024)				 ::flixel::text::_FlxText::FlxTextFormatRange formatRange = _g1->__get(_g).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
HXDLIN(1024)				_g = (_g + 1);
HXLINE(1026)				int _hx_tmp1 = (this->textField->get_text().length - 1);
HXDLIN(1026)				if (::hx::IsLess( _hx_tmp1,formatRange->range->start )) {
HXLINE(1029)					goto _hx_goto_59;
            				}
            				else {
HXLINE(1033)					 ::openfl::text::TextFormat textFormat = formatRange->format->format;
HXLINE(1034)					this->copyTextFormat(textFormat,FormatAdjusted,false);
HXLINE(1035)					 ::Dynamic _hx_tmp2;
HXDLIN(1035)					if (UseBorderColor) {
HXLINE(1035)						_hx_tmp2 = (formatRange->format->borderColor & 16777215);
            					}
            					else {
HXLINE(1035)						_hx_tmp2 = textFormat->color;
            					}
HXDLIN(1035)					FormatAdjusted->color = _hx_tmp2;
            				}
HXLINE(1038)				 ::openfl::text::TextField _hx_tmp3 = this->textField;
HXDLIN(1038)				int formatRange1 = ( (int)(formatRange->range->start) );
HXDLIN(1038)				int formatRange2 = ( (int)(formatRange->range->end) );
HXDLIN(1038)				_hx_tmp3->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(( (Float)(formatRange2) ),( (Float)(this->textField->get_text().length) ))));
            			}
            			_hx_goto_59:;
            		}
            	}
...
void FlxText_obj::copyTextFormat( ::openfl::text::TextFormat from, ::openfl::text::TextFormat to,::hx::Null< bool >  __o_withAlign){
            	...
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_1043_copyTextFormat)
HXLINE(1044)		to->font = from->font;
HXLINE(1045)		to->bold = from->bold;
HXLINE(1046)		to->italic = from->italic;
HXLINE(1047)		to->size = from->size;
HXLINE(1048)		to->color = from->color;
HXLINE(1049)		to->leading = from->leading;
HXLINE(1050)		if (withAlign) {
HXLINE(1051)			to->align = from->align;
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,copyTextFormat,(void))
 ...
 ::openfl::text::TextFormat FlxText_obj::dtfCopy(){
            	HX_GC_STACKFRAME(&_hx_pos_7d9cf70d988be490_1060_dtfCopy)
HXLINE(1061)		 ::openfl::text::TextFormat dtf = this->textField->get_defaultTextFormat();
HXLINE(1062)		return  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,dtf->font,dtf->size,dtf->color,dtf->bold,dtf->italic,dtf->underline,dtf->url,dtf->target,dtf->align,null(),null(),null(),null());
            	}
...
void FlxText_obj::updateDefaultFormat(){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_1066_updateDefaultFormat)
HXLINE(1067)		this->textField->set_defaultTextFormat(this->_defaultFormat);
HXLINE(1068)		this->textField->setTextFormat(this->_defaultFormat,null(),null());
HXLINE(1069)		this->_regen = true;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxText_obj,updateDefaultFormat,(void))
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxText_obj::set_frames( ::flixel::graphics::frames::FlxFramesCollection Frames){
            	HX_STACKFRAME(&_hx_pos_7d9cf70d988be490_1073_set_frames)
HXLINE(1074)		this->super::set_frames(Frames);
HXLINE(1075)		this->_regen = false;
HXLINE(1076)		return Frames;
            	}
