...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7213395c1228ff_2339_new,"StorySprite","new",0xc315e7ac,"StorySprite.new","MainMenuStateAmmar.hx",2339,0x38c8c245)
HX_LOCAL_STACK_FRAME(_hx_pos_3b7213395c1228ff_2364_update,"StorySprite","update",0xcfa8063d,"StorySprite.update","MainMenuStateAmmar.hx",2364,0x38c8c245)
...
void StorySprite_obj::__construct(Float x,Float y,::String path, ::Dynamic scaleMultiply,::hx::Null< int >  __o_orda){
            	...
            	HX_STACKFRAME(&_hx_pos_3b7213395c1228ff_2339_new)
HXLINE(2348)		this->daOrder = 0;
HXLINE(2347)		this->zoomSin = false;
HXLINE(2346)		this->sinOff = ((Float)0);
HXLINE(2345)		this->sinY = false;
HXLINE(2344)		this->centery = ((Float)0);
HXLINE(2343)		this->centerx = ((Float)0);
HXLINE(2352)		super::__construct(x,y,null());
HXLINE(2353)		::String library = null();
HXDLIN(2353)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(path,library);
HXDLIN(2353)		this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(2354)		if (::hx::IsNotNull( scaleMultiply )) {
HXLINE(2355)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(scaleMultiply) ))),null());
HXLINE(2356)			this->updateHitbox();
            		}
HXLINE(2358)		{
HXLINE(2358)			int axes = 17;
HXDLIN(2358)			bool _hx_tmp;
HXDLIN(2358)			if ((axes != 1)) {
HXLINE(2358)				_hx_tmp = (axes == 17);
            			}
            			else {
HXLINE(2358)				_hx_tmp = true;
            			}
HXDLIN(2358)			if (_hx_tmp) {
HXLINE(2358)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(2358)				this->set_x(((( (Float)(_hx_tmp1) ) - this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2358)			bool _hx_tmp2;
HXDLIN(2358)			if ((axes != 16)) {
HXLINE(2358)				_hx_tmp2 = (axes == 17);
            			}
            			else {
HXLINE(2358)				_hx_tmp2 = true;
            			}
HXDLIN(2358)			if (_hx_tmp2) {
HXLINE(2358)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(2358)				this->set_y(((( (Float)(_hx_tmp3) ) - this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(2359)		this->centerx = x;
HXLINE(2360)		this->centery = y;
HXLINE(2361)		this->daOrder = orda;
            	}
...
void StorySprite_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3b7213395c1228ff_2364_update)
HXLINE(2365)		if (this->sinY) {
HXLINE(2366)			this->set_y((this->centery + (::Math_obj::sin(((( (Float)(::flixel::FlxG_obj::game->ticks) ) / ( (Float)(800) )) + this->sinOff)) * ( (Float)(5) ))));
            		}
HXLINE(2367)		if (this->zoomSin) {
HXLINE(2368)			Float scal = (((Float)1.11) + (::Math_obj::sin((this->sinOff + (( (Float)(::flixel::FlxG_obj::game->ticks) ) / ( (Float)(780) )))) * ((Float)0.1)));
HXLINE(2369)			{
HXLINE(2369)				 ::flixel::math::FlxBasePoint this1 = this->scale;
HXDLIN(2369)				this1->set_x(scal);
HXDLIN(2369)				this1->set_y(scal);
            			}
            		}
            	}
