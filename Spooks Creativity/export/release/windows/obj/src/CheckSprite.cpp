...
HX_DEFINE_STACK_FRAME(_hx_pos_a9be513903d60a44_2380_new,"CheckSprite","new",0xb355d23f,"CheckSprite.new","MainMenuStateAmmar.hx",2380,0x38c8c245)
HX_LOCAL_STACK_FRAME(_hx_pos_a9be513903d60a44_2404_update,"CheckSprite","update",0x5de0b98a,"CheckSprite.update","MainMenuStateAmmar.hx",2404,0x38c8c245)
...
void CheckSprite_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< int >  __o_difficulty){
            	...
            	HX_STACKFRAME(&_hx_pos_a9be513903d60a44_2380_new)
HXLINE(2390)		this->noMove = false;
HXLINE(2389)		this->partOf = HX_("",00,00,00,00);
HXLINE(2387)		this->addY = ((Float)0);
HXLINE(2386)		this->addX = ((Float)0);
HXLINE(2385)		this->followPartner = false;
HXLINE(2382)		this->objectID = 0;
HXLINE(2394)		super::__construct(X,Y,null());
HXLINE(2395)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(2397)		::String path = ((HX_("ammar/",bd,7a,a1,d3) + ::MainMenuStateAmmar_obj::difficultyArray->__get(difficulty)) + HX_("Tick",7d,ef,d5,37));
HXLINE(2398)		::String library = null();
HXDLIN(2398)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(path,null());
HXDLIN(2398)		bool xmlExists = false;
HXDLIN(2398)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + path) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE(2398)			xmlExists = true;
            		}
HXDLIN(2398)		 ::Dynamic _hx_tmp;
HXDLIN(2398)		if (::hx::IsNotNull( imageLoaded )) {
HXLINE(2398)			_hx_tmp = imageLoaded;
            		}
            		else {
HXLINE(2398)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(path,library);
HXDLIN(2398)			_hx_tmp = returnAsset;
            		}
HXDLIN(2398)		 ::Dynamic _hx_tmp1;
HXDLIN(2398)		if (xmlExists) {
HXLINE(2398)			_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + path) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(2398)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + path) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(2398)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE(2399)		this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Checkmark",b5,bc,2f,53),10,true,null(),null());
HXLINE(2400)		this->animation->play(HX_("idle",14,a7,b3,45),true,null(),null());
            	}
...
void CheckSprite_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a9be513903d60a44_2404_update)
HXLINE(2405)		this->super::update(elapsed);
HXLINE(2406)		bool _hx_tmp;
HXDLIN(2406)		if (this->followPartner) {
HXLINE(2406)			_hx_tmp = ::hx::IsNotNull( this->partner );
            		}
            		else {
HXLINE(2406)			_hx_tmp = false;
            		}
HXDLIN(2406)		if (_hx_tmp) {
HXLINE(2407)			this->set_x((this->partner->x + this->addX));
HXLINE(2408)			this->set_y((this->partner->y + this->addY));
            		}
            	}
