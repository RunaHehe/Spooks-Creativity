...
HXLINE(  46)			{
HXLINE(  46)				 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXLINE(  49)			{
HXLINE(  49)				 ::flixel::sound::FlxSound _this1 = ::flixel::FlxG_obj::sound->music;
...
HXDLIN( 144)		 ::flixel::sound::FlxSound _hx_tmp39 = _hx_tmp38->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 193)							 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
