...
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_434_updatePitch,"lime._internal.backend.native.NativeAudioSource","updatePitch",0xe908ab31,"lime._internal.backend.native.NativeAudioSource.updatePitch","lime/_internal/backend/native/NativeAudioSource.hx",434,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_458_getPitch,"lime._internal.backend.native.NativeAudioSource","getPitch",0x835f7cd0,"lime._internal.backend.native.NativeAudioSource.getPitch","lime/_internal/backend/native/NativeAudioSource.hx",458,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_463_setPitch,"lime._internal.backend.native.NativeAudioSource","setPitch",0x31bcd644,"lime._internal.backend.native.NativeAudioSource.setPitch","lime/_internal/backend/native/NativeAudioSource.hx",463,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_468_getGain,"lime._internal.backend.native.NativeAudioSource","getGain",0x29af016f,"lime._internal.backend.native.NativeAudioSource.getGain","lime/_internal/backend/native/NativeAudioSource.hx",468,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_479_setGain,"lime._internal.backend.native.NativeAudioSource","setGain",0x1cb0927b,"lime._internal.backend.native.NativeAudioSource.setGain","lime/_internal/backend/native/NativeAudioSource.hx",479,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_489_getLength,"lime._internal.backend.native.NativeAudioSource","getLength",0x8531c1d6,"lime._internal.backend.native.NativeAudioSource.getLength","lime/_internal/backend/native/NativeAudioSource.hx",489,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_499_setLength,"lime._internal.backend.native.NativeAudioSource","setLength",0x6882ade2,"lime._internal.backend.native.NativeAudioSource.setLength","lime/_internal/backend/native/NativeAudioSource.hx",499,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_521_getLoops,"lime._internal.backend.native.NativeAudioSource","getLoops",0x39b8b29f,"lime._internal.backend.native.NativeAudioSource.getLoops","lime/_internal/backend/native/NativeAudioSource.hx",521,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_526_setLoops,"lime._internal.backend.native.NativeAudioSource","setLoops",0xe8160c13,"lime._internal.backend.native.NativeAudioSource.setLoops","lime/_internal/backend/native/NativeAudioSource.hx",526,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_530_getPosition,"lime._internal.backend.native.NativeAudioSource","getPosition",0x31bde999,"lime._internal.backend.native.NativeAudioSource.getPosition","lime/_internal/backend/native/NativeAudioSource.hx",530,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_545_setPosition,"lime._internal.backend.native.NativeAudioSource","setPosition",0x3c2af0a5,"lime._internal.backend.native.NativeAudioSource.setPosition","lime/_internal/backend/native/NativeAudioSource.hx",545,0xce8e0834)
...
HXLINE( 432)		this->_hx___pitch = ((Float)1);
...
HXLINE(  99)			::cpp::Int64 x = vorbisFile->pcmTotal(null());
...
HXLINE( 176)			this->streamTimer =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(::Std_obj::_hx_int((( (Float)(::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_TIMER_FREQUENCY) ) / this->_hx___pitch))) ));
...
HXDLIN( 210)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN( 210)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN( 210)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXLINE( 253)				::cpp::Int64 x = vorbisFile->pcmTell();
...
HXLINE( 267)				::cpp::Int64 x1 = vorbisFile->pcmTell();
...
HXLINE( 418)				this->completed = false;
HXLINE( 419)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->_hx___pitch))) ));
HXLINE( 420)				this->timer->run = this->timer_onRun_dyn();
            			}
            			else {
HXLINE( 424)				this->playing = false;
HXLINE( 425)				this->completed = true;
            			}
            		}
...
Float NativeAudioSource_obj::updatePitch(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_434_updatePitch)
HXLINE( 436)		this->_hx___pitch = value;
HXLINE( 437)		if (this->playing) {
HXLINE( 439)			if (::hx::IsNotNull( this->timer )) {
HXLINE( 441)				this->timer->stop();
            			}
HXLINE( 444)			int timeRemaining = this->getLength();
HXDLIN( 444)			int timeRemaining1 = (timeRemaining - this->getCurrentTime());
HXLINE( 446)			if ((timeRemaining1 > 0)) {
HXLINE( 448)				this->completed = false;
HXLINE( 449)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(::Std_obj::_hx_int((( (Float)(timeRemaining1) ) / this->_hx___pitch))) ));
HXLINE( 450)				this->timer->run = this->timer_onRun_dyn();
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(NativeAudioSource_obj,updatePitch,return )

Float NativeAudioSource_obj::getPitch(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_458_getPitch)
HXDLIN( 458)		return this->_hx___pitch;
            	}


HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,getPitch,return )

Float NativeAudioSource_obj::setPitch(Float val){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_463_setPitch)
HXDLIN( 463)		return this->updatePitch(val);
            	}
...
Float NativeAudioSource_obj::getGain(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_468_getGain)
HXDLIN( 468)		if (::hx::IsNotNull( this->handle )) {
HXLINE( 470)			return ::lime::media::openal::AL_obj::getSourcef(this->handle,4106);
            		}
            		else {
HXLINE( 474)			return ( (Float)(1) );
            		}
HXLINE( 468)		return ((Float)0.);
            	}
...
Float NativeAudioSource_obj::setGain(Float value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_479_setGain)
HXLINE( 480)		if (::hx::IsNotNull( this->handle )) {
HXLINE( 482)			::lime::media::openal::AL_obj::sourcef(this->handle,4106,value);
            		}
...
int NativeAudioSource_obj::getLength(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_489_getLength)
HXLINE( 490)		if (::hx::IsNotNull( this->length )) {
HXLINE( 492)			return ( (int)(this->length) );
            		}
HXLINE( 495)		int _hx_tmp = ::Std_obj::_hx_int(((( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) )) * ( (Float)(1000) )));
HXDLIN( 495)		return (_hx_tmp - this->parent->offset);
            	}
...
int NativeAudioSource_obj::setLength(int value){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_499_setLength)
HXLINE( 500)		bool _hx_tmp;
HXDLIN( 500)		if (this->playing) {
HXLINE( 500)			_hx_tmp = ::hx::IsNotEq( this->length,value );
            		}
            		else {
HXLINE( 500)			_hx_tmp = false;
            		}
HXDLIN( 500)		if (_hx_tmp) {
HXLINE( 502)			if (::hx::IsNotNull( this->timer )) {
HXLINE( 504)				this->timer->stop();
            			}
HXLINE( 507)			int timeRemaining = (value - this->getCurrentTime());
HXLINE( 509)			if ((timeRemaining > 0)) {
HXLINE( 511)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->_hx___pitch))) ));
HXLINE( 512)				this->timer->run = this->timer_onRun_dyn();
            			}
            		}
HXLINE( 516)		return ( (int)((this->length = value)) );
            	}
...
int NativeAudioSource_obj::getLoops(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_521_getLoops)
HXDLIN( 521)		return this->loops;
            	}
...
int NativeAudioSource_obj::setLoops(int value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_526_setLoops)
HXDLIN( 526)		return (this->loops = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(NativeAudioSource_obj,setLoops,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::getPosition(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_530_getPosition)
HXLINE( 531)		if (::hx::IsNotNull( this->handle )) {
HXLINE( 534)			::Array< Float > value = ::lime::media::openal::AL_obj::getSource3f(this->handle,4100);
HXLINE( 535)			this->position->x = value->__get(0);
HXLINE( 536)			this->position->y = value->__get(1);
HXLINE( 537)			this->position->z = value->__get(2);
            		}
HXLINE( 541)		return this->position;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,getPosition,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::setPosition( ::lime::math::Vector4 value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_545_setPosition)
HXLINE( 546)		this->position->x = value->x;
HXLINE( 547)		this->position->y = value->y;
HXLINE( 548)		this->position->z = value->z;
HXLINE( 549)		this->position->w = value->w;
HXLINE( 551)		if (::hx::IsNotNull( this->handle )) {
HXLINE( 553)			::lime::media::openal::AL_obj::distanceModel(0);
HXLINE( 554)			::lime::media::openal::AL_obj::source3f(this->handle,4100,this->position->x,this->position->y,this->position->z);
            		}
HXLINE( 557)		return this->position;
            	}
...
::hx::Val NativeAudioSource_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"updatePitch") ) { return ::hx::Val( updatePitch_dyn() ); }
...
void NativeAudioSource_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("__pitch",a0,14,ff,2c));
...
static ::hx::StorageInfo NativeAudioSource_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsFloat,(int)offsetof(NativeAudioSource_obj,_hx___pitch),HX_("__pitch",a0,14,ff,2c)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String NativeAudioSource_obj_sMemberFields[] = {
	...
	HX_("__pitch",a0,14,ff,2c),
	HX_("updatePitch",f7,24,39,a8),
