...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_38_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",38,0x775e99e9)
...
void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_38_new)
HXLINE(  51)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  50)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  49)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  47)		this->speed = ((Float)1);
...
HXLINE(  64)			{
HXLINE(  64)				int _g = 0;
HXDLIN(  64)				int _g1 = ( (int)( ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
...
HXLINE(  76)							 ::Dynamic(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic))->__Field(HX_("push",da,11,61,4a),::hx::paccDynamic)(::Array_obj< ::Dynamic>::__new(2)->init(0,note->__get(0))->init(1,::Array_obj< ::Dynamic>::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_94_loadFromJson)
HXLINE(  95)		::String rawJson = null();
HXLINE(  97)		 ::EReg invalidChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXDLIN(  97)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXDLIN(  97)		::String path = invalidChars->split(::StringTools_obj::replace(folder,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
HXDLIN(  97)		::String formattedFolder = hideChars->split(path)->join(HX_("",00,00,00,00)).toLowerCase();
HXLINE(  98)		 ::EReg invalidChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXDLIN(  98)		 ::EReg hideChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXDLIN(  98)		::String path1 = invalidChars1->split(::StringTools_obj::replace(jsonInput,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
HXDLIN(  98)		::String formattedSong = hideChars1->split(path1)->join(HX_("",00,00,00,00)).toLowerCase();
