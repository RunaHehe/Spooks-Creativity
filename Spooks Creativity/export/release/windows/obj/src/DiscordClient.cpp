...
HX_DEFINE_STACK_FRAME(_hx_pos_e5abf8620039da0e_19_new,"DiscordClient","new",0xa1a2b969,"DiscordClient.new","Discord.hx",19,0xa6c9e0b2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_66_onError,"DiscordClient","onError",0xf57a0bb2,"DiscordClient.onError","Discord.hx",66,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_73_onDisconnected,"DiscordClient","onDisconnected",0xa84d7d11,"DiscordClient.onDisconnected","Discord.hx",73,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_82_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",82,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_78_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",78,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_90_changePresence,"DiscordClient","changePresence",0xb0052162,"DiscordClient.changePresence","Discord.hx",90,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_122_addLuaCallbacks,"DiscordClient","addLuaCallbacks",0x51cfc080,"DiscordClient.addLuaCallbacks","Discord.hx",122,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_120_addLuaCallbacks,"DiscordClient","addLuaCallbacks",0x51cfc080,"DiscordClient.addLuaCallbacks","Discord.hx",120,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_17_boot,"DiscordClient","boot",0xc4d88309,"DiscordClient.boot","Discord.hx",17,0xa6c9e0b2)

void DiscordClient_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_19_new)
HXLINE(  21)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),21,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  22)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("1312097234426531911",96,8c,c3,e9))
            			->setFixed(3,HX_("onReady",c4,3e,f8,7c),::DiscordClient_obj::onReady_dyn())));
HXLINE(  28)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),28,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  30)		while(true){
HXLINE(  32)			::discord_rpc::DiscordRpc_obj::process();
HXLINE(  33)			::Sys_obj::sleep(( (Float)(2) ));
            		}
            	}
...
HXLINE(  53)		::String SpookImageKey;
HXDLIN(  53)		if (::ClientPrefs_obj::cute) {
HXLINE(  53)			SpookImageKey = HX_("cutelogo",8e,79,67,f0);
            		}
            		else {
HXLINE(  53)			SpookImageKey = HX_("logo",6b,9f,b7,47);
            		}
HXLINE(  55)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),null())
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("In the Menus",0a,c1,ad,c6))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),SpookImageKey)
...
void DiscordClient_obj::onError(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_66_onError)
HXDLIN(  66)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),66,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
void DiscordClient_obj::onDisconnected(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_73_onDisconnected)
HXDLIN(  73)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),73,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
void DiscordClient_obj::initialize(){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_e5abf8620039da0e_82_initialize)
HXLINE(  82)			 ::DiscordClient_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_78_initialize)
HXLINE(  80)		 ::sys::thread::_Thread::HaxeThread DiscordDaemon = ::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_0()),false);
HXLINE(  84)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),84,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
HXLINE(  85)		::DiscordClient_obj::isInitialized = true;
            	}
...
void DiscordClient_obj::changePresence(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_90_changePresence)
HXLINE(  92)		Float startTimestamp;
HXDLIN(  92)		if (( (bool)(hasStartTimestamp) )) {
HXLINE(  92)			startTimestamp = ::Date_obj::now()->getTime();
            		}
            		else {
HXLINE(  92)			startTimestamp = ( (Float)(0) );
            		}
HXLINE(  94)		if (::hx::IsGreater( endTimestamp,0 )) {
HXLINE(  96)			endTimestamp = (startTimestamp + endTimestamp);
            		}
HXLINE( 101)		::String SpookImageKey;
HXDLIN( 101)		if (::ClientPrefs_obj::cute) {
HXLINE( 101)			SpookImageKey = HX_("cutelogo",8e,79,67,f0);
            		}
            		else {
HXLINE( 101)			SpookImageKey = HX_("logo",6b,9f,b7,47);
            		}
HXLINE( 107)		::String _hx_tmp = (HX_("Engine Version: ",e0,15,79,71) + ::MainMenuState_obj::psychEngineVersion);
HXLINE( 110)		 ::Dynamic _hx_tmp1 = ::Std_obj::_hx_int((startTimestamp / ( (Float)(1000) )));
HXLINE( 103)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),SpookImageKey)
...
void DiscordClient_obj::addLuaCallbacks( cpp::Reference<lua_State> lua){
            		...
            		void _hx_run(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            			HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_122_addLuaCallbacks)
HXLINE( 122)			::DiscordClient_obj::changePresence(details,state,smallImageKey,hasStartTimestamp,endTimestamp);
            		}
            		HX_END_LOCAL_FUNC5((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_120_addLuaCallbacks)
HXDLIN( 120)		::llua::Lua_helper_obj::callbacks->set(HX_("changePresence",cb,8f,12,c0), ::Dynamic(new _hx_Closure_0()));
HXDLIN( 120)		linc::callbacks::add_callback_function(lua,HX_("changePresence",cb,8f,12,c0));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_17_boot)
HXDLIN(  17)		isInitialized = false;
            	}
}
