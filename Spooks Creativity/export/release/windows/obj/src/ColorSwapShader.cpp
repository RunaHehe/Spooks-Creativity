...
HX_DEFINE_STACK_FRAME(_hx_pos_ffb46a49cbb76713_239_new,"ColorSwapShader","new",0x2f3c9fad,"ColorSwapShader.new","ColorSwap.hx",239,0x580efb08)

void ColorSwapShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ffb46a49cbb76713_239_new)
...
HXLINE(  56)		this->_hx___isGenerated = true;
HXDLIN(  56)		this->_hx___initGL();
            	}
...
::hx::Val ColorSwapShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"flash") ) { flash=inValue.Cast<  ::openfl::display::ShaderParameter_Float >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"daAlpha") ) { daAlpha=inValue.Cast<  ::openfl::display::ShaderParameter_Float >(); return inValue; }
		break;
	case 14:
...
static ::hx::StorageInfo ColorSwapShader_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(ColorSwapShader_obj,daAlpha),HX_("daAlpha",a1,7a,c4,bb)},
	{::hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(ColorSwapShader_obj,flash),HX_("flash",b0,35,8c,02)},
