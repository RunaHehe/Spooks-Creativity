...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Spooks Creativity",d3,c4,ef,22),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("13",e2,2a,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Spook",ae,a6,9e,14));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Spooks Creativity",d3,c4,ef,22));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Spook's Creativity V1",6a,af,92,45));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.spook.spookscreativity",ca,8c,a6,88));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Spook's Creativity V1",6a,af,92,45))
