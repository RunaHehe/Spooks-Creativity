...
HX_DEFINE_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_265_new,"AlphaCharacter","new",0xcdf30efd,"AlphaCharacter.new","Alphabet.hx",265,0xc2e40fcb)
static const Float _hx_array_data_b92ecc8b_1[] = {
	(Float)0,(Float)0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_393_set_image,"AlphaCharacter","set_image",0xe6aefa1b,"AlphaCharacter.set_image","Alphabet.hx",393,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_417_updateLetterOffset,"AlphaCharacter","updateLetterOffset",0x9dbb5ec5,"AlphaCharacter.updateLetterOffset","Alphabet.hx",417,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_387_isTypeAlphabet,"AlphaCharacter","isTypeAlphabet",0x16f1111a,"AlphaCharacter.isTypeAlphabet","Alphabet.hx",387,0xc2e40fcb)
...
void AlphaCharacter_obj::__construct(Float x,Float y,::String character,bool bold, ::Alphabet parent){
            	HX_GC_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_265_new)
HXLINE( 327)		this->rowWidth = ((Float)0);
HXLINE( 326)		this->row = 0;
HXLINE( 324)		this->spawnScale =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXLINE( 323)		this->spawnPos =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXLINE( 322)		this->letterOffset = ::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_1,2);
HXLINE( 321)		this->alignOffset = ((Float)0);
HXLINE( 330)		super::__construct(x,y,null());
HXLINE( 331)		this->parent = parent;
HXLINE( 332)		this->set_image(HX_("alphabet",b3,7c,38,21));
HXLINE( 333)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 335)		 ::Dynamic curLetter = ::AlphaCharacter_obj::allLetters->get(HX_("?",3f,00,00,00));
HXLINE( 336)		::String lowercase = character.toLowerCase();
HXLINE( 337)		if (::AlphaCharacter_obj::allLetters->exists(lowercase)) {
HXLINE( 337)			curLetter = ::AlphaCharacter_obj::allLetters->get(lowercase);
            		}
HXLINE( 339)		::String suffix = HX_("",00,00,00,00);
HXLINE( 340)		if (!(bold)) {
HXLINE( 342)			if (::AlphaCharacter_obj::isTypeAlphabet(lowercase)) {
HXLINE( 344)				if ((lowercase != character)) {
HXLINE( 345)					suffix = HX_(" uppercase",f2,8c,8d,f0);
            				}
            				else {
HXLINE( 347)					suffix = HX_(" lowercase",11,a9,f4,6f);
            				}
            			}
            			else {
HXLINE( 351)				suffix = HX_(" normal",47,4a,18,63);
HXLINE( 352)				bool _hx_tmp;
HXDLIN( 352)				if (::hx::IsNotNull( curLetter )) {
HXLINE( 352)					_hx_tmp = ::hx::IsNotNull( curLetter->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) );
            				}
            				else {
HXLINE( 352)					_hx_tmp = false;
            				}
HXDLIN( 352)				if (_hx_tmp) {
HXLINE( 354)					this->letterOffset[0] = ( (Float)( ::Dynamic(curLetter->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0)) );
HXLINE( 355)					this->letterOffset[1] = ( (Float)( ::Dynamic(curLetter->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1)) );
            				}
            			}
            		}
            		else {
HXLINE( 361)			suffix = HX_(" bold",a5,11,ee,ad);
HXLINE( 362)			bool _hx_tmp1;
HXDLIN( 362)			if (::hx::IsNotNull( curLetter )) {
HXLINE( 362)				_hx_tmp1 = ::hx::IsNotNull( curLetter->__Field(HX_("offsetsBold",25,77,5c,68),::hx::paccDynamic) );
            			}
            			else {
HXLINE( 362)				_hx_tmp1 = false;
            			}
HXDLIN( 362)			if (_hx_tmp1) {
HXLINE( 364)				this->letterOffset[0] = ( (Float)( ::Dynamic(curLetter->__Field(HX_("offsetsBold",25,77,5c,68),::hx::paccDynamic))->__GetItem(0)) );
HXLINE( 365)				this->letterOffset[1] = ( (Float)( ::Dynamic(curLetter->__Field(HX_("offsetsBold",25,77,5c,68),::hx::paccDynamic))->__GetItem(1)) );
            			}
            		}
HXLINE( 369)		::String alphaAnim = lowercase;
HXLINE( 370)		bool _hx_tmp2;
HXDLIN( 370)		if (::hx::IsNotNull( curLetter )) {
HXLINE( 370)			_hx_tmp2 = ::hx::IsNotNull( curLetter->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 370)			_hx_tmp2 = false;
            		}
HXDLIN( 370)		if (_hx_tmp2) {
HXLINE( 370)			alphaAnim = ( (::String)(curLetter->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) );
            		}
HXLINE( 372)		::String anim = (alphaAnim + suffix);
HXLINE( 373)		this->animation->addByPrefix(anim,anim,24,null(),null(),null());
HXLINE( 374)		this->animation->play(anim,true,null(),null());
HXLINE( 375)		if (::hx::IsNull( this->animation->_curAnim )) {
HXLINE( 377)			if ((suffix != HX_(" bold",a5,11,ee,ad))) {
HXLINE( 377)				suffix = HX_(" normal",47,4a,18,63);
            			}
HXLINE( 378)			anim = (HX_("question",26,9b,b0,26) + suffix);
HXLINE( 379)			this->animation->addByPrefix(anim,anim,24,null(),null(),null());
HXLINE( 380)			this->animation->play(anim,true,null(),null());
            		}
HXLINE( 382)		this->updateHitbox();
HXLINE( 383)		this->updateLetterOffset();
            	}
...
::String AlphaCharacter_obj::set_image(::String name){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_393_set_image)
HXLINE( 394)		::String lastAnim = null();
HXLINE( 395)		if (::hx::IsNotNull( this->animation )) {
HXLINE( 397)			lastAnim = this->animation->get_name();
            		}
HXLINE( 399)		this->image = name;
HXLINE( 400)		::String library = null();
HXDLIN( 400)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(name,null());
HXDLIN( 400)		bool xmlExists = false;
HXDLIN( 400)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 400)			xmlExists = true;
            		}
HXDLIN( 400)		 ::Dynamic _hx_tmp;
HXDLIN( 400)		if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 400)			_hx_tmp = imageLoaded;
            		}
            		else {
HXLINE( 400)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(name,library);
HXDLIN( 400)			_hx_tmp = returnAsset;
            		}
HXDLIN( 400)		 ::Dynamic _hx_tmp1;
HXDLIN( 400)		if (xmlExists) {
HXLINE( 400)			_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 400)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN( 400)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 401)		this->scale->set_x(this->parent->scaleX);
HXLINE( 402)		this->scale->set_y(this->parent->scaleY);
HXLINE( 403)		this->alignOffset = ( (Float)(0) );
HXLINE( 405)		if (::hx::IsNotNull( lastAnim )) {
HXLINE( 407)			this->animation->addByPrefix(lastAnim,lastAnim,24,null(),null(),null());
HXLINE( 408)			this->animation->play(lastAnim,true,null(),null());
HXLINE( 410)			this->updateHitbox();
HXLINE( 411)			this->updateLetterOffset();
            		}
HXLINE( 413)		return name;
            	}
...
void AlphaCharacter_obj::updateLetterOffset(){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_417_updateLetterOffset)
HXLINE( 418)		if (::hx::IsNull( this->animation->_curAnim )) {
HXLINE( 418)			return;
            		}
HXLINE( 420)		if (!(::StringTools_obj::endsWith(this->animation->_curAnim->name,HX_("bold",85,81,1b,41)))) {
HXLINE( 422)			 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN( 422)			Float y = this->offset->y;
HXDLIN( 422)			this1->set_y((y + -((( (Float)(110) ) - this->get_height()))));
            		}
            	}
...
bool AlphaCharacter_obj::isTypeAlphabet(::String c){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_387_isTypeAlphabet)
HXLINE( 388)		int ascii = c.cca(0);
HXLINE( 389)		bool _hx_tmp;
HXDLIN( 389)		if ((ascii >= 65)) {
HXLINE( 389)			_hx_tmp = (ascii <= 90);
            		}
            		else {
HXLINE( 389)			_hx_tmp = false;
            		}
HXDLIN( 389)		if (!(_hx_tmp)) {
HXLINE( 389)			if ((ascii >= 97)) {
HXLINE( 389)				return (ascii <= 122);
            			}
            			else {
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::haxe::ds::StringMap _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_273_boot)
HXDLIN( 273)			 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value = null();
HXDLIN( 273)				_g->set(HX_("a",61,00,00,00),value);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value1 = null();
HXDLIN( 273)				_g->set(HX_("b",62,00,00,00),value1);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value2 = null();
HXDLIN( 273)				_g->set(HX_("c",63,00,00,00),value2);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value3 = null();
HXDLIN( 273)				_g->set(HX_("d",64,00,00,00),value3);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value4 = null();
HXDLIN( 273)				_g->set(HX_("e",65,00,00,00),value4);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value5 = null();
HXDLIN( 273)				_g->set(HX_("f",66,00,00,00),value5);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value6 = null();
HXDLIN( 273)				_g->set(HX_("g",67,00,00,00),value6);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value7 = null();
HXDLIN( 273)				_g->set(HX_("h",68,00,00,00),value7);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value8 = null();
HXDLIN( 273)				_g->set(HX_("i",69,00,00,00),value8);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value9 = null();
HXDLIN( 273)				_g->set(HX_("j",6a,00,00,00),value9);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value10 = null();
HXDLIN( 273)				_g->set(HX_("k",6b,00,00,00),value10);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value11 = null();
HXDLIN( 273)				_g->set(HX_("l",6c,00,00,00),value11);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value12 = null();
HXDLIN( 273)				_g->set(HX_("m",6d,00,00,00),value12);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value13 = null();
HXDLIN( 273)				_g->set(HX_("n",6e,00,00,00),value13);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value14 = null();
HXDLIN( 273)				_g->set(HX_("o",6f,00,00,00),value14);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value15 = null();
HXDLIN( 273)				_g->set(HX_("p",70,00,00,00),value15);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value16 = null();
HXDLIN( 273)				_g->set(HX_("q",71,00,00,00),value16);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value17 = null();
HXDLIN( 273)				_g->set(HX_("r",72,00,00,00),value17);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value18 = null();
HXDLIN( 273)				_g->set(HX_("s",73,00,00,00),value18);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value19 = null();
HXDLIN( 273)				_g->set(HX_("t",74,00,00,00),value19);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value20 = null();
HXDLIN( 273)				_g->set(HX_("u",75,00,00,00),value20);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value21 = null();
HXDLIN( 273)				_g->set(HX_("v",76,00,00,00),value21);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value22 = null();
HXDLIN( 273)				_g->set(HX_("w",77,00,00,00),value22);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value23 = null();
HXDLIN( 273)				_g->set(HX_("x",78,00,00,00),value23);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value24 = null();
HXDLIN( 273)				_g->set(HX_("y",79,00,00,00),value24);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value25 = null();
HXDLIN( 273)				_g->set(HX_("z",7a,00,00,00),value25);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value26 = null();
HXDLIN( 273)				_g->set(HX_("0",30,00,00,00),value26);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value27 = null();
HXDLIN( 273)				_g->set(HX_("1",31,00,00,00),value27);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value28 = null();
HXDLIN( 273)				_g->set(HX_("2",32,00,00,00),value28);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value29 = null();
HXDLIN( 273)				_g->set(HX_("3",33,00,00,00),value29);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value30 = null();
HXDLIN( 273)				_g->set(HX_("4",34,00,00,00),value30);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value31 = null();
HXDLIN( 273)				_g->set(HX_("5",35,00,00,00),value31);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value32 = null();
HXDLIN( 273)				_g->set(HX_("6",36,00,00,00),value32);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value33 = null();
HXDLIN( 273)				_g->set(HX_("7",37,00,00,00),value33);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value34 = null();
HXDLIN( 273)				_g->set(HX_("8",38,00,00,00),value34);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value35 = null();
HXDLIN( 273)				_g->set(HX_("9",39,00,00,00),value35);
            			}
HXDLIN( 273)			_g->set(HX_("&",26,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsetsBold",25,77,5c,68),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_6,2))));
HXDLIN( 273)			_g->set(HX_("(",28,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsetsBold",25,77,5c,68),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_7,2))));
HXDLIN( 273)			_g->set(HX_(")",29,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsetsBold",25,77,5c,68),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_8,2))));
HXDLIN( 273)			_g->set(HX_("*",2a,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_9,2))));
HXDLIN( 273)			_g->set(HX_("+",2b,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("-",2d,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("<",3c,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsetsBold",25,77,5c,68),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_14,2))));
HXDLIN( 273)			_g->set(HX_(">",3e,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsetsBold",25,77,5c,68),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_15,2))));
HXDLIN( 273)			_g->set(HX_("'",27,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("\"",22,00,00,00), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN( 273)			_g->set(HX_("!",21,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("?",3f,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_(".",2e,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_W(u"\u275d",06c2,00ac), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN( 273)			_g->set(HX_W(u"\u275e",06c3,00ac), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value36 = null();
HXDLIN( 273)				_g->set(HX_("_",5f,00,00,00),value36);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value37 = null();
HXDLIN( 273)				_g->set(HX_("#",23,00,00,00),value37);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value38 = null();
HXDLIN( 273)				_g->set(HX_("$",24,00,00,00),value38);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value39 = null();
HXDLIN( 273)				_g->set(HX_("%",25,00,00,00),value39);
            			}
HXDLIN( 273)			_g->set(HX_(":",3a,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_26,2))));
HXDLIN( 273)			_g->set(HX_(";",3b,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_27,2))));
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value40 = null();
HXDLIN( 273)				_g->set(HX_("@",40,00,00,00),value40);
            			}
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value41 = null();
HXDLIN( 273)				_g->set(HX_("[",5b,00,00,00),value41);
            			}
HXDLIN( 273)			_g->set(HX_("]",5d,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_28,2))));
HXDLIN( 273)			_g->set(HX_("^",5e,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_29,2))));
HXDLIN( 273)			_g->set(HX_(",",2c,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("\\",5c,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			_g->set(HX_("/",2f,00,00,00), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN( 273)			{
HXDLIN( 273)				 ::Dynamic value42 = null();
HXDLIN( 273)				_g->set(HX_("|",7c,00,00,00),value42);
            			}
HXDLIN( 273)			_g->set(HX_("~",7e,00,00,00), ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("offsets",80,09,65,d7),::Array_obj< Float >::fromData( _hx_array_data_b92ecc8b_33,2))));
HXDLIN( 273)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_273_boot)
HXDLIN( 273)		allLetters = ( ( ::haxe::ds::StringMap)( ::Dynamic(new _hx_Closure_0())()) );
            	}
}
