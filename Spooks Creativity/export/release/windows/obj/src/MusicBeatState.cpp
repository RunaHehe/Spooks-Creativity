...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_141_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",141,0xa1b2f108)
...
HXDLIN( 129)					 ::flixel::FlxState stateOnCall = ::flixel::FlxG_obj::game->_state;
HXDLIN( 129)					 ::Dynamic _hx_tmp = ::Reflect_obj::field(::flixel::FlxG_obj::game->_state,HX_("switchTo",8f,f8,d6,0d));
HXDLIN( 129)					if (( (bool)(_hx_tmp(nextState)) )) {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxState,nextState, ::flixel::FlxState,stateOnCall) HXARGC(0)
            						void _hx_run(){
            							HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_129_switchState)
HXLINE( 129)							if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 129)								::flixel::FlxG_obj::game->_requestedState = nextState;
            							}
            							else {
HXLINE( 129)								::flixel::FlxG_obj::log->advanced(HX_("`onOutroComplete` was called after the state was switched. This will be ignored",46,b2,58,c7),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            							}
            						}
            						HX_END_LOCAL_FUNC0((void))

HXLINE( 129)						::flixel::FlxG_obj::game->_state->startOutro( ::Dynamic(new _hx_Closure_0(nextState,stateOnCall)));
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 128)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_1());
            			}
            			else {
...
HXLINE( 134)					 ::flixel::FlxState nextState1 = nextState;
...
HXDLIN( 134)					if (( (bool)(_hx_tmp(nextState1)) )) {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_2, ::flixel::FlxState,nextState1, ::flixel::FlxState,stateOnCall) HXARGC(0)
            						void _hx_run(){
            							HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_134_switchState)
HXLINE( 134)							if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 134)								::flixel::FlxG_obj::game->_requestedState = nextState1;
            							}
            							else {
HXLINE( 134)								::flixel::FlxG_obj::log->advanced(HX_("`onOutroComplete` was called after the state was switched. This will be ignored",46,b2,58,c7),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            							}
            						}
            						HX_END_LOCAL_FUNC0((void))

HXLINE( 134)						::flixel::FlxG_obj::game->_state->startOutro( ::Dynamic(new _hx_Closure_2(nextState1,stateOnCall)));
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 133)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_3(nextState));
            			}
HXLINE( 138)			return;
            		}
HXLINE( 140)		::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = false;
HXLINE( 141)		{
HXLINE( 141)			 ::flixel::FlxState nextState1 = nextState;
HXDLIN( 141)			 ::flixel::FlxState stateOnCall = ::flixel::FlxG_obj::game->_state;
HXDLIN( 141)			 ::Dynamic _hx_tmp = ::Reflect_obj::field(::flixel::FlxG_obj::game->_state,HX_("switchTo",8f,f8,d6,0d));
HXDLIN( 141)			if (( (bool)(_hx_tmp(nextState1)) )) {
            				HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_4, ::flixel::FlxState,nextState1, ::flixel::FlxState,stateOnCall) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_141_switchState)
HXLINE( 141)					if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 141)						::flixel::FlxG_obj::game->_requestedState = nextState1;
            					}
            					else {
HXLINE( 141)						::flixel::FlxG_obj::log->advanced(HX_("`onOutroComplete` was called after the state was switched. This will be ignored",46,b2,58,c7),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 141)				::flixel::FlxG_obj::game->_state->startOutro( ::Dynamic(new _hx_Closure_4(nextState1,stateOnCall)));
            			}
            		}
            	}
