...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_541_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",541,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_541_new)
HXLINE( 547)		this->folder = HX_("",00,00,00,00);
HXLINE( 546)		this->color = -7179779;
HXLINE( 545)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 544)		this->week = 0;
HXLINE( 543)		this->songName = HX_("",00,00,00,00);
...
HXLINE( 555)		this->folder = ::Paths_obj::currentModDirectory;
