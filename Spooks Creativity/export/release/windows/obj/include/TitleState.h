...
class HXCPP_CLASS_ATTRIBUTES TitleState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		bool danceLeft;
		 ...
		 ::flixel::FlxSprite anammar;
		 ::flixel::FlxSprite creativity;
		 ::flixel::addons::display::FlxBackdrop checks;
		 ::flixel::addons::display::FlxBackdrop checksDark;
		 ::flixel::addons::display::FlxBackdrop dotsGradient;
		bool logoCanBeat;
		void startIntro();
		...
		::Array< ::String > songsToCache;
		void cacheSongs();
		::Dynamic cacheSongs_dyn();
