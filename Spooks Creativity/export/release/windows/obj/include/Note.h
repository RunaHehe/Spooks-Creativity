...
class HXCPP_CLASS_ATTRIBUTES Note_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		static Float swagWidth;
		 ::math::Vector3 vec3Cache;
		 ::flixel::math::FlxBasePoint defScale;
		void destroy();
		...
		void setupNote(Float strumTime,int noteData, ::Note prevNote, ::Dynamic sustainNote, ::Dynamic inEditor);
		::Dynamic setupNote_dyn();
