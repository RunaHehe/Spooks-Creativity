...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic voices(::String song,::String suffix);
		static ::Dynamic voices_dyn();

		static  ::Dynamic voicesPlayer(::String song,::String suffix);
		static ::Dynamic voicesPlayer_dyn();

		static  ::Dynamic voicesOpponent(::String song,::String suffix);
		static ::Dynamic voicesOpponent_dyn();

		static bool voicesExist(::String song,::String addition);
		static ::Dynamic voicesExist_dyn();

		static  ::Dynamic inst(::String song,::String suffix);
		static ::Dynamic inst_dyn();

		static bool instExist(::String song,::String addition);
		static ::Dynamic instExist_dyn();
