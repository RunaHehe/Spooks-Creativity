...
class HXCPP_CLASS_ATTRIBUTES CustomFadeTransition_obj : public  ::MusicBeatSubstate_obj
{
	...
	public:
		...
		static ::Array< ::String > chars;
		static bool newLoading;
		 ::flixel::tweens::FlxTween leTween;
		bool isTransIn;
		 ::flixel::FlxSprite transBlack;
		 ::flixel::FlxSprite transGradient;
		 ::flixel::FlxSprite loading;
		 ::flixel::FlxSprite _hx_char;
		 ::flixel::tweens::FlxTween charTween;
		 ::flixel::tweens::FlxTween loadingTween;
