...
class HXCPP_CLASS_ATTRIBUTES BaseOptionsMenu_obj : public  ::MusicBeatSubstate_obj
{
	...
	public:
		...
		::String title;
		::String rpcTitle;
		 ::flixel::FlxSprite downButton;
		 ::flixel::FlxSprite upButton;
		 ::flixel::FlxSprite leftButton;
		 ::flixel::FlxSprite rightButton;
		 ::flixel::FlxSprite acceptButton;
		::Array< bool > holdPress;
