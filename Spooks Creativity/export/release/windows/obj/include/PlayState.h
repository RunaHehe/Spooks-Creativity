...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static ::Dynamic cancelMusicFadeTween_dyn();
		 ...
		 ::modchart::ModManager modManager;
		::Array< ::Dynamic> notesToSpawn;
		bool useModchart;
		...
		Float noteKillOffset;
		 ...
		 ::flixel::group::FlxTypedGroup grpNoteHoldSplashes;
		bool camZooming;
		...
		int combo;
		 ...
		 ::AttachedSprite healthBarOverlay;
		Float songPercent;
		...
		int bads;
		int shits;
		 ::flixel::FlxSprite comboSpr;
		Float comboSprY;
		 ::flixel::FlxSprite comboNumSpr;
		 ::flixel::tweens::FlxTween comboSprTween;
		 ::flixel::tweens::FlxTween comboNumSprTween;
		bool generatedMusic;
		bool endingSong;
		bool startingSong;
		bool updateTime;
		...
		bool boyfriendIdled;
		 ::flixel::group::FlxTypedGroup mobileControls;
		...
		::Array< ::Dynamic> VOCALS;
		 ::BGSprite discordBG;
		 ::BGSprite discordTopBar;
		 ::BGSprite discordMessage;
		 ::stagesprite::DiscordChannels discordChannels;
		 ::stagesprite::DiscordMembers discordMembers;
		 ::stagesprite::DiscordUser discordPlayer;
		 ::stagesprite::DiscordUser discordOpponent;
		 ::BGSprite redOverlay;
		 ::flixel::FlxSprite glitchy;
		 ::BGSprite ytBG;
		 ::BGSprite ytBGVideo;
		 ::BGSprite ytBGVideoTitle;
		 ::BGSprite ytTopBar;
		 ::BGSprite ytBGTopBar;
		 ::flixel::text::FlxText ytComments;
		 ::shaders::OldTelevision oldTelevisionShader;
		 ::shaders::Glitching glitchingShader;
		 ::BGSprite backGlow;
		 ::BGSprite backGlowOver;
		 ::BGSprite downGlow;
		 ::flixel::effects::particles::FlxTypedEmitter voidParticles;
		::String ratePrefix;
		::String scorePrefix;
		::String missPrefix;
		::String comboPrefix;
		...
		Float lerpHealth;
		::String hudStyle;
		 ::stagesprite::AttachedNormalText discordHealthText;
		bool newHealthSystem;
		bool HUDtoRight;
		 ::flixel::FlxSprite lightHUD;
		 ::flixel::tweens::FlxTween lightHUDTween;
		::Array< int > noteColor;
		bool enableCoolLightNote;
		 ::flixel::text::FlxText songTitle;
		 ::flixel::FlxSprite songLogo;
		 ::flixel::text::FlxText songDesc;
		 ::flixel::text::FlxText songDiff;
		 ::flixel::text::FlxText countdownText;
		 ::flixel::tweens::FlxTween countdownTween;
		 ::flixel::tweens::FlxTween countdownTweenColor;
		 ::flixel::util::FlxTimer introTimer;
		void create();

		 ::flixel::text::FlxText scoreTxt;
		 ::flixel::text::FlxText rateTxt;
		 ::flixel::text::FlxText comboTxt;
		 ::flixel::text::FlxText missTxt;
		 ::flixel::tweens::FlxTween scoreTxtTween;
		 ::flixel::tweens::FlxTween rateTxtTween;
		 ::flixel::tweens::FlxTween comboTxtTween;
		 ::flixel::tweens::FlxTween missTxtTween;
		::Array< ::Dynamic> barOffset;
		Float lerpShakeBar;
		void createHUD();
		::Dynamic createHUD_dyn();

		int sortByTimeVocals( ::Dynamic Obj1, ::Dynamic Obj2);
		::Dynamic sortByTimeVocals_dyn();

		::Array< ::Dynamic> vocalsSetup();
		::Dynamic vocalsSetup_dyn();

		void createMobileControls();
		::Dynamic createMobileControls_dyn();
		...
		::Dynamic startCharacterPos_dyn();
		 ...
		 ::hxvlc::flixel::FlxVideoSprite videoCutscene;
		...
		int sortByOrderNote(int wat, ::Note Obj1, ::Note Obj2);
		::Dynamic sortByOrderNote_dyn();

		int sortByOrderStrumNote(int wat, ::StrumNote Obj1, ::StrumNote Obj2);
		::Dynamic sortByOrderStrumNote_dyn();
		...
		bool beatHardSnares;
		Float zoomMultiply;
		bool opponentHitDistract;
		Float shakeNote;
		void songStepEvent();
		::Dynamic songStepEvent_dyn();

		void songUpdateEvent();
		::Dynamic songUpdateEvent_dyn();
