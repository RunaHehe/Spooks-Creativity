...
class HXCPP_CLASS_ATTRIBUTES ChartingState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		int CAM_OFFSET;
		 ...
		 ::flixel::FlxSprite dummyArrowImage;
		::Array< ::String > dummyArrowArray;
		...
		::String currentSongName;
		 ...
		 ::flixel::text::FlxText difficultySong;
		::String difficulty;
		...
		::Array< int > noteColor;
		int curPrevBeat;
		 ::haxe::ds::StringMap mouseGraphics;
		 ::flixel::FlxSprite mouseSprite;
		::Array< ::Dynamic> sprSelectables;
		::cpp::VirtualArray vocalKeybinds;
		Float instVol;
		Float allVoicesVol;
		Float voicesVol;
		Float oppVoicesVol;
		...
		::String currentNoteType;
		 ::flixel::addons::ui::FlxUICheckBox check_deleteOnlyNoteType;
		 ::flixel::addons::ui::FlxUICheckBox check_showOnlyNoteType;
		 ::flixel::addons::ui::FlxUICheckBox check_ignoreAddNotes;
		int currentType;
		void addNoteUI();
		...
		::Dynamic setAllLabelsOffset_dyn();
		 ...
		 ::flixel::addons::ui::FlxUINumericStepper opponentVolume;
		void addChartingUI();
		...
		void updateGrid(::hx::Null< bool >  onlyMainSec);
		::Dynamic updateGrid_dyn();

		 ::Note setupNoteData(::cpp::VirtualArray i,bool isNextSection,::hx::Null< bool >  isPrevSection,::hx::Null< bool >  vocalNote);
		...
		void updateCameraIcon(::hx::Null< Float >  elapsed);
		::Dynamic updateCameraIcon_dyn();
		...
		void addNote( ::Dynamic strum, ::Dynamic data, ::Dynamic type, ::Dynamic vocalType);
		::Dynamic addNote_dyn();
		...
		void saveLevelInstant();
		::Dynamic saveLevelInstant_dyn();

		void reloadEvents();
		::Dynamic reloadEvents_dyn();
		...
		void loadCursor(::String name);
		::Dynamic loadCursor_dyn();
