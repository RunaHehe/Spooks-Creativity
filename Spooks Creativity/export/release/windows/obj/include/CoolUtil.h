...
class HXCPP_CLASS_ATTRIBUTES CoolUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::flixel::math::FlxBasePoint rotate(Float x,Float y,Float angle, ::flixel::math::FlxBasePoint point);
		static ::Dynamic rotate_dyn();

		static Float continuous_sin(Float x);
		static ::Dynamic continuous_sin_dyn();

		static Float continuous_cos(Float x);
		static ::Dynamic continuous_cos_dyn();

		static Float quantizeAlpha(Float f,Float interval);
		static ::Dynamic quantizeAlpha_dyn();
