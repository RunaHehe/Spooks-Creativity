...
--------------------------------------------------
    ...
    if showBF then
        ...
        setProperty('bfPhantom.y',getProperty('boyfriend.y') + getProperty('boyfriend.frameHeight')*getProperty('boyfriend.scale.y') * 2.1 - bfoffsetY * 2 + BFYFix)
    end
...
-----------------------------boyfriend sprite---------------------
    ...
    if showDAD then
        ...
        setProperty('dadPhantom.y',getProperty('dad.y') + getProperty('dad.frameHeight') * getProperty('dad.scale.y') * 1.8 - dadoffsetY * 2 + DADYFix)
    end
